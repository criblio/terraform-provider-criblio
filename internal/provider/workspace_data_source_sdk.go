...
func (r *WorkspaceDataSourceModel) ToOperationsV1WorkspacesListWorkspacesRequest(ctx context.Context) (*operations.V1WorkspacesListWorkspacesRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
