...
type OutputGrafanaCloud struct {
	...
	ExtraHTTPHeaders              []OutputGrafanaCloudExtraHTTPHeader      `tfsdk:"extra_http_headers"`
	...
	Labels                        []OutputGrafanaCloudLabel                `tfsdk:"labels"`
	...
	ResponseRetrySettings         []OutputGrafanaCloudResponseRetrySetting `tfsdk:"response_retry_settings"`
