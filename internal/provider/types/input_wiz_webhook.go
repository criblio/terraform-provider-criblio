...
type InputWizWebhook struct {
	...
	AuthTokensExt         []InputWizWebhookAuthTokensExt        `tfsdk:"auth_tokens_ext"`
	BreakerRulesets       []types.String                        `tfsdk:"breaker_rulesets"`
	CaptureHeaders        types.Bool                            `tfsdk:"capture_headers"`
	Connections           []InputWizWebhookConnection           `tfsdk:"connections"`
	...
	Metadata              []InputWizWebhookMetadatum            `tfsdk:"metadata"`
	Pipeline              types.String                          `tfsdk:"pipeline"`
	Port                  types.Float64                         `tfsdk:"port"`
	Pq                    *InputWizWebhookPq                    `tfsdk:"pq"`
	...
	TLS                   *InputWizWebhookTLSSettingsServerSide `tfsdk:"tls"`
