...
type InputPrometheus struct {
	...
	TemplateDiscoveryType        types.String                   `tfsdk:"template_discovery_type"`
	TemplateLogLevel             types.String                   `tfsdk:"template_log_level"`
	TemplatePassword             types.String                   `tfsdk:"template_password"`
	...
	SearchFilter                 []ItemsTypeSearchFilter        `tfsdk:"search_filter"`
