...
type OutputGrafanaCloudGrafanaCloud2 struct {
	TemplateLokiURL               types.String                               `tfsdk:"template_loki_url"`
	TemplatePrometheusURL         types.String                               `tfsdk:"template_prometheus_url"`
	...
	Labels                        []ItemsTypeContentConfigItemsRequestParams `tfsdk:"labels"`
	LokiAuth                      *PrometheusAuthType                        `tfsdk:"loki_auth"`
	...
	PrometheusAuth                *PrometheusAuthType                        `tfsdk:"prometheus_auth"`
