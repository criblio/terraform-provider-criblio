...
type OutputMicrosoftFabric struct {
	...
	PqControls                *OutputMicrosoftFabricPqControls            `tfsdk:"pq_controls"`
	...
	Sasl                      *OutputMicrosoftFabricAuthentication        `tfsdk:"sasl"`
	Streamtags                []types.String                              `tfsdk:"streamtags"`
	SystemFields              []types.String                              `tfsdk:"system_fields"`
	TLS                       *OutputMicrosoftFabricTLSSettingsClientSide `tfsdk:"tls"`
