...
type InputCloudflareHec struct {
	...
	AuthTokens                []InputCloudflareHecAuthToken            `tfsdk:"auth_tokens"`
	BreakerRulesets           []types.String                           `tfsdk:"breaker_rulesets"`
	CaptureHeaders            types.Bool                               `tfsdk:"capture_headers"`
	Connections               []InputCloudflareHecConnection           `tfsdk:"connections"`
	...
	Metadata                  []InputCloudflareHecMetadatum            `tfsdk:"metadata"`
	Pipeline                  types.String                             `tfsdk:"pipeline"`
	Port                      types.Float64                            `tfsdk:"port"`
	Pq                        *InputCloudflareHecPq                    `tfsdk:"pq"`
	...
	TLS                       *InputCloudflareHecTLSSettingsServerSide `tfsdk:"tls"`
