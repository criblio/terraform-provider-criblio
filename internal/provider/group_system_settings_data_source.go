...
// GroupSystemSettingsLegacyDataSourceModel describes the legacy data source shape.
type GroupSystemSettingsLegacyDataSourceModel struct {
...
func (r *GroupSystemSettingsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *GroupSystemSettingsLegacyDataSourceModel
