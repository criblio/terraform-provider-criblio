...
func (r *CriblLakeHouseResourceModel) RefreshFromOperationsCreateDefaultLakeLakehouseResponseBody(ctx context.Context, resp *operations.CreateDefaultLakeLakehouseResponseBody) diag.Diagnostics {
...
func (r *CriblLakeHouseResourceModel) RefreshFromOperationsUpdateDefaultLakeLakehouseByIDResponseBody(ctx context.Context, resp *operations.UpdateDefaultLakeLakehouseByIDResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
