...
func (r *DatabaseConnectionResourceModel) RefreshFromOperationsCreateDatabaseConnectionConfigResponseBody(ctx context.Context, resp *operations.CreateDatabaseConnectionConfigResponseBody) diag.Diagnostics {
	...
	if resp != nil {
		...
		diags.Append(r.RefreshFromSharedDatabaseConnectionConfig(ctx, &resp.Items[0])...)
...
func (r *DatabaseConnectionResourceModel) RefreshFromOperationsUpdateDatabaseConnectionConfigByIDResponseBody(ctx context.Context, resp *operations.UpdateDatabaseConnectionConfigByIDResponseBody) diag.Diagnostics {
	var diags diag.Diagnostics
