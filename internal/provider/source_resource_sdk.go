...
func (r *SourceResourceModel) ToSharedInput(ctx context.Context) (*shared.Input, diag.Diagnostics) {
	...
	if r.InputSyslog != nil {
		id46 := new(string)
		if !r.InputSyslog.ID.IsUnknown() && !r.InputSyslog.ID.IsNull() {
			*id46 = r.InputSyslog.ID.ValueString()
		} else {
			id46 = nil
		}
		typeVar50 := shared.InputSyslogType(r.InputSyslog.Type.ValueString())
		disabled83 := new(bool)
		if !r.InputSyslog.Disabled.IsUnknown() && !r.InputSyslog.Disabled.IsNull() {
			*disabled83 = r.InputSyslog.Disabled.ValueBool()
		} else {
			disabled83 = nil
		}
		pipeline92 := new(string)
		if !r.InputSyslog.Pipeline.IsUnknown() && !r.InputSyslog.Pipeline.IsNull() {
			*pipeline92 = r.InputSyslog.Pipeline.ValueString()
		} else {
			pipeline92 = nil
		}
		sendToRoutes46 := new(bool)
		if !r.InputSyslog.SendToRoutes.IsUnknown() && !r.InputSyslog.SendToRoutes.IsNull() {
			*sendToRoutes46 = r.InputSyslog.SendToRoutes.ValueBool()
		} else {
			sendToRoutes46 = nil
		}
		environment46 := new(string)
		if !r.InputSyslog.Environment.IsUnknown() && !r.InputSyslog.Environment.IsNull() {
			*environment46 = r.InputSyslog.Environment.ValueString()
		} else {
			environment46 = nil
		}
		pqEnabled46 := new(bool)
		if !r.InputSyslog.PqEnabled.IsUnknown() && !r.InputSyslog.PqEnabled.IsNull() {
			*pqEnabled46 = r.InputSyslog.PqEnabled.ValueBool()
		} else {
			pqEnabled46 = nil
		}
		streamtags46 := make([]string, 0, len(r.InputSyslog.Streamtags))
		for streamtagsIndex46 := range r.InputSyslog.Streamtags {
			streamtags46 = append(streamtags46, r.InputSyslog.Streamtags[streamtagsIndex46].ValueString())
		}
		connections46 := make([]shared.InputSyslogConnection, 0, len(r.InputSyslog.Connections))
		for connectionsIndex46 := range r.InputSyslog.Connections {
			pipeline93 := new(string)
			if !r.InputSyslog.Connections[connectionsIndex46].Pipeline.IsUnknown() && !r.InputSyslog.Connections[connectionsIndex46].Pipeline.IsNull() {
				*pipeline93 = r.InputSyslog.Connections[connectionsIndex46].Pipeline.ValueString()
			} else {
				pipeline93 = nil
			}
			var output47 string
			output47 = r.InputSyslog.Connections[connectionsIndex46].Output.ValueString()

			connections46 = append(connections46, shared.InputSyslogConnection{
				Pipeline: pipeline93,
				Output:   output47,
			})
		}
		var pq46 *shared.InputSyslogPq
		if r.InputSyslog.Pq != nil {
			mode59 := new(shared.InputSyslogMode)
			if !r.InputSyslog.Pq.Mode.IsUnknown() && !r.InputSyslog.Pq.Mode.IsNull() {
				*mode59 = shared.InputSyslogMode(r.InputSyslog.Pq.Mode.ValueString())
			} else {
				mode59 = nil
			}
			maxBufferSize48 := new(float64)
			if !r.InputSyslog.Pq.MaxBufferSize.IsUnknown() && !r.InputSyslog.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize48 = r.InputSyslog.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize48 = nil
			}
			commitFrequency46 := new(float64)
			if !r.InputSyslog.Pq.CommitFrequency.IsUnknown() && !r.InputSyslog.Pq.CommitFrequency.IsNull() {
				*commitFrequency46 = r.InputSyslog.Pq.CommitFrequency.ValueFloat64()
			} else {
				commitFrequency46 = nil
			}
			maxFileSize46 := new(string)
			if !r.InputSyslog.Pq.MaxFileSize.IsUnknown() && !r.InputSyslog.Pq.MaxFileSize.IsNull() {
				*maxFileSize46 = r.InputSyslog.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize46 = nil
			}
			maxSize46 := new(string)
			if !r.InputSyslog.Pq.MaxSize.IsUnknown() && !r.InputSyslog.Pq.MaxSize.IsNull() {
				*maxSize46 = r.InputSyslog.Pq.MaxSize.ValueString()
			} else {
				maxSize46 = nil
			}
			path47 := new(string)
			if !r.InputSyslog.Pq.Path.IsUnknown() && !r.InputSyslog.Pq.Path.IsNull() {
				*path47 = r.InputSyslog.Pq.Path.ValueString()
			} else {
				path47 = nil
			}
			compress53 := new(shared.InputSyslogCompression)
			if !r.InputSyslog.Pq.Compress.IsUnknown() && !r.InputSyslog.Pq.Compress.IsNull() {
				*compress53 = shared.InputSyslogCompression(r.InputSyslog.Pq.Compress.ValueString())
			} else {
				compress53 = nil
			}
		...
		host21 := new(string)
		if !r.InputSyslog.Host.IsUnknown() && !r.InputSyslog.Host.IsNull() {
			*host21 = r.InputSyslog.Host.ValueString()
		} else {
			host21 = nil
		}
		udpPort1 := new(float64)
		if !r.InputSyslog.UDPPort.IsUnknown() && !r.InputSyslog.UDPPort.IsNull() {
			*udpPort1 = r.InputSyslog.UDPPort.ValueFloat64()
		} else {
			udpPort1 = nil
		}
		tcpPort1 := new(float64)
		if !r.InputSyslog.TCPPort.IsUnknown() && !r.InputSyslog.TCPPort.IsNull() {
			*tcpPort1 = r.InputSyslog.TCPPort.ValueFloat64()
		} else {
			tcpPort1 = nil
		}
		maxBufferSize49 := new(float64)
		if !r.InputSyslog.MaxBufferSize.IsUnknown() && !r.InputSyslog.MaxBufferSize.IsNull() {
			*maxBufferSize49 = r.InputSyslog.MaxBufferSize.ValueFloat64()
		} else {
			maxBufferSize49 = nil
		}
		ipWhitelistRegex4 := new(string)
		if !r.InputSyslog.IPWhitelistRegex.IsUnknown() && !r.InputSyslog.IPWhitelistRegex.IsNull() {
			*ipWhitelistRegex4 = r.InputSyslog.IPWhitelistRegex.ValueString()
		} else {
			ipWhitelistRegex4 = nil
		}
		timestampTimezone := new(string)
		if !r.InputSyslog.TimestampTimezone.IsUnknown() && !r.InputSyslog.TimestampTimezone.IsNull() {
			*timestampTimezone = r.InputSyslog.TimestampTimezone.ValueString()
		} else {
			timestampTimezone = nil
		}
		singleMsgUDPPackets := new(bool)
		if !r.InputSyslog.SingleMsgUDPPackets.IsUnknown() && !r.InputSyslog.SingleMsgUDPPackets.IsNull() {
			*singleMsgUDPPackets = r.InputSyslog.SingleMsgUDPPackets.ValueBool()
		} else {
			singleMsgUDPPackets = nil
		}
		enableProxyHeader16 := new(bool)
		if !r.InputSyslog.EnableProxyHeader.IsUnknown() && !r.InputSyslog.EnableProxyHeader.IsNull() {
			*enableProxyHeader16 = r.InputSyslog.EnableProxyHeader.ValueBool()
		} else {
			enableProxyHeader16 = nil
		}
		keepFieldsList := make([]string, 0, len(r.InputSyslog.KeepFieldsList))
		for keepFieldsListIndex := range r.InputSyslog.KeepFieldsList {
			keepFieldsList = append(keepFieldsList, r.InputSyslog.KeepFieldsList[keepFieldsListIndex].ValueString())
		}
		octetCounting := new(bool)
		if !r.InputSyslog.OctetCounting.IsUnknown() && !r.InputSyslog.OctetCounting.IsNull() {
			*octetCounting = r.InputSyslog.OctetCounting.ValueBool()
		} else {
			octetCounting = nil
		}
		inferFraming := new(bool)
		if !r.InputSyslog.InferFraming.IsUnknown() && !r.InputSyslog.InferFraming.IsNull() {
			*inferFraming = r.InputSyslog.InferFraming.ValueBool()
		} else {
			inferFraming = nil
		}
		strictlyInferOctetCounting := new(bool)
		if !r.InputSyslog.StrictlyInferOctetCounting.IsUnknown() && !r.InputSyslog.StrictlyInferOctetCounting.IsNull() {
			*strictlyInferOctetCounting = r.InputSyslog.StrictlyInferOctetCounting.ValueBool()
		} else {
			strictlyInferOctetCounting = nil
		}
		allowNonStandardAppName := new(bool)
		if !r.InputSyslog.AllowNonStandardAppName.IsUnknown() && !r.InputSyslog.AllowNonStandardAppName.IsNull() {
			*allowNonStandardAppName = r.InputSyslog.AllowNonStandardAppName.ValueBool()
		} else {
			allowNonStandardAppName = nil
		}
		maxActiveCxn5 := new(float64)
		if !r.InputSyslog.MaxActiveCxn.IsUnknown() && !r.InputSyslog.MaxActiveCxn.IsNull() {
			*maxActiveCxn5 = r.InputSyslog.MaxActiveCxn.ValueFloat64()
		} else {
			maxActiveCxn5 = nil
		}
		socketIdleTimeout3 := new(float64)
		if !r.InputSyslog.SocketIdleTimeout.IsUnknown() && !r.InputSyslog.SocketIdleTimeout.IsNull() {
			*socketIdleTimeout3 = r.InputSyslog.SocketIdleTimeout.ValueFloat64()
		} else {
			socketIdleTimeout3 = nil
		}
		socketEndingMaxWait3 := new(float64)
		if !r.InputSyslog.SocketEndingMaxWait.IsUnknown() && !r.InputSyslog.SocketEndingMaxWait.IsNull() {
			*socketEndingMaxWait3 = r.InputSyslog.SocketEndingMaxWait.ValueFloat64()
		} else {
			socketEndingMaxWait3 = nil
		}
		socketMaxLifespan3 := new(float64)
		if !r.InputSyslog.SocketMaxLifespan.IsUnknown() && !r.InputSyslog.SocketMaxLifespan.IsNull() {
			*socketMaxLifespan3 = r.InputSyslog.SocketMaxLifespan.ValueFloat64()
		} else {
			socketMaxLifespan3 = nil
		}
		var tls24 *shared.InputSyslogTLSSettingsServerSide
		if r.InputSyslog.TLS != nil {
			disabled84 := new(bool)
			if !r.InputSyslog.TLS.Disabled.IsUnknown() && !r.InputSyslog.TLS.Disabled.IsNull() {
				*disabled84 = r.InputSyslog.TLS.Disabled.ValueBool()
			} else {
				disabled84 = nil
			}
			certificateName25 := new(string)
			if !r.InputSyslog.TLS.CertificateName.IsUnknown() && !r.InputSyslog.TLS.CertificateName.IsNull() {
				*certificateName25 = r.InputSyslog.TLS.CertificateName.ValueString()
			} else {
				certificateName25 = nil
			}
			privKeyPath24 := new(string)
			if !r.InputSyslog.TLS.PrivKeyPath.IsUnknown() && !r.InputSyslog.TLS.PrivKeyPath.IsNull() {
				*privKeyPath24 = r.InputSyslog.TLS.PrivKeyPath.ValueString()
			} else {
				privKeyPath24 = nil
			}
			passphrase23 := new(string)
			if !r.InputSyslog.TLS.Passphrase.IsUnknown() && !r.InputSyslog.TLS.Passphrase.IsNull() {
				*passphrase23 = r.InputSyslog.TLS.Passphrase.ValueString()
			} else {
				passphrase23 = nil
			}
			certPath24 := new(string)
			if !r.InputSyslog.TLS.CertPath.IsUnknown() && !r.InputSyslog.TLS.CertPath.IsNull() {
				*certPath24 = r.InputSyslog.TLS.CertPath.ValueString()
			} else {
				certPath24 = nil
			}
			caPath23 := new(string)
			if !r.InputSyslog.TLS.CaPath.IsUnknown() && !r.InputSyslog.TLS.CaPath.IsNull() {
				*caPath23 = r.InputSyslog.TLS.CaPath.ValueString()
			} else {
				caPath23 = nil
			}
			requestCert17 := new(bool)
			if !r.InputSyslog.TLS.RequestCert.IsUnknown() && !r.InputSyslog.TLS.RequestCert.IsNull() {
				*requestCert17 = r.InputSyslog.TLS.RequestCert.ValueBool()
			} else {
				requestCert17 = nil
			}
			var rejectUnauthorized35 interface{}
			if !r.InputSyslog.TLS.RejectUnauthorized.IsUnknown() && !r.InputSyslog.TLS.RejectUnauthorized.IsNull() {
				_ = json.Unmarshal([]byte(r.InputSyslog.TLS.RejectUnauthorized.ValueString()), &rejectUnauthorized35)
			}
			var commonNameRegex17 interface{}
			if !r.InputSyslog.TLS.CommonNameRegex.IsUnknown() && !r.InputSyslog.TLS.CommonNameRegex.IsNull() {
				_ = json.Unmarshal([]byte(r.InputSyslog.TLS.CommonNameRegex.ValueString()), &commonNameRegex17)
			}
			minVersion23 := new(shared.InputSyslogMinimumTLSVersion)
			if !r.InputSyslog.TLS.MinVersion.IsUnknown() && !r.InputSyslog.TLS.MinVersion.IsNull() {
				*minVersion23 = shared.InputSyslogMinimumTLSVersion(r.InputSyslog.TLS.MinVersion.ValueString())
			} else {
				minVersion23 = nil
			}
			maxVersion23 := new(shared.InputSyslogMaximumTLSVersion)
			if !r.InputSyslog.TLS.MaxVersion.IsUnknown() && !r.InputSyslog.TLS.MaxVersion.IsNull() {
				*maxVersion23 = shared.InputSyslogMaximumTLSVersion(r.InputSyslog.TLS.MaxVersion.ValueString())
			} else {
				maxVersion23 = nil
			}
		...
		metadata50 := make([]shared.InputSyslogMetadatum, 0, len(r.InputSyslog.Metadata))
		for metadataIndex49 := range r.InputSyslog.Metadata {
			var name69 string
			name69 = r.InputSyslog.Metadata[metadataIndex49].Name.ValueString()

			var value64 string
			value64 = r.InputSyslog.Metadata[metadataIndex49].Value.ValueString()

			metadata50 = append(metadata50, shared.InputSyslogMetadatum{
				Name:  name69,
				Value: value64,
			})
		}
		udpSocketRxBufSize2 := new(float64)
		if !r.InputSyslog.UDPSocketRxBufSize.IsUnknown() && !r.InputSyslog.UDPSocketRxBufSize.IsNull() {
			*udpSocketRxBufSize2 = r.InputSyslog.UDPSocketRxBufSize.ValueFloat64()
		} else {
			udpSocketRxBufSize2 = nil
		}
		enableLoadBalancing3 := new(bool)
		if !r.InputSyslog.EnableLoadBalancing.IsUnknown() && !r.InputSyslog.EnableLoadBalancing.IsNull() {
			*enableLoadBalancing3 = r.InputSyslog.EnableLoadBalancing.ValueBool()
		} else {
			enableLoadBalancing3 = nil
		}
		description55 := new(string)
		if !r.InputSyslog.Description.IsUnknown() && !r.InputSyslog.Description.IsNull() {
			*description55 = r.InputSyslog.Description.ValueString()
		} else {
			description55 = nil
		}
		enableEnhancedProxyHeaderParsing := new(bool)
		if !r.InputSyslog.EnableEnhancedProxyHeaderParsing.IsUnknown() && !r.InputSyslog.EnableEnhancedProxyHeaderParsing.IsNull() {
			*enableEnhancedProxyHeaderParsing = r.InputSyslog.EnableEnhancedProxyHeaderParsing.ValueBool()
		} else {
	...
	if r.InputFile != nil {
		var id47 string
		id47 = r.InputFile.ID.ValueString()

		typeVar51 := shared.InputFileType(r.InputFile.Type.ValueString())
		disabled85 := new(bool)
		if !r.InputFile.Disabled.IsUnknown() && !r.InputFile.Disabled.IsNull() {
			*disabled85 = r.InputFile.Disabled.ValueBool()
		} else {
			disabled85 = nil
		}
		pipeline94 := new(string)
		if !r.InputFile.Pipeline.IsUnknown() && !r.InputFile.Pipeline.IsNull() {
			*pipeline94 = r.InputFile.Pipeline.ValueString()
		} else {
			pipeline94 = nil
		}
		sendToRoutes47 := new(bool)
		if !r.InputFile.SendToRoutes.IsUnknown() && !r.InputFile.SendToRoutes.IsNull() {
			*sendToRoutes47 = r.InputFile.SendToRoutes.ValueBool()
		} else {
			sendToRoutes47 = nil
		}
		environment47 := new(string)
		if !r.InputFile.Environment.IsUnknown() && !r.InputFile.Environment.IsNull() {
			*environment47 = r.InputFile.Environment.ValueString()
		} else {
			environment47 = nil
		}
		pqEnabled47 := new(bool)
		if !r.InputFile.PqEnabled.IsUnknown() && !r.InputFile.PqEnabled.IsNull() {
			*pqEnabled47 = r.InputFile.PqEnabled.ValueBool()
		} else {
			pqEnabled47 = nil
		}
		streamtags47 := make([]string, 0, len(r.InputFile.Streamtags))
		for streamtagsIndex47 := range r.InputFile.Streamtags {
			streamtags47 = append(streamtags47, r.InputFile.Streamtags[streamtagsIndex47].ValueString())
		}
		connections47 := make([]shared.InputFileConnection, 0, len(r.InputFile.Connections))
		for connectionsIndex47 := range r.InputFile.Connections {
			pipeline95 := new(string)
			if !r.InputFile.Connections[connectionsIndex47].Pipeline.IsUnknown() && !r.InputFile.Connections[connectionsIndex47].Pipeline.IsNull() {
				*pipeline95 = r.InputFile.Connections[connectionsIndex47].Pipeline.ValueString()
			} else {
				pipeline95 = nil
			}
			var output48 string
			output48 = r.InputFile.Connections[connectionsIndex47].Output.ValueString()

			connections47 = append(connections47, shared.InputFileConnection{
				Pipeline: pipeline95,
				Output:   output48,
			})
		}
		var pq47 *shared.InputFilePq
		if r.InputFile.Pq != nil {
			mode60 := new(shared.InputFilePqMode)
			if !r.InputFile.Pq.Mode.IsUnknown() && !r.InputFile.Pq.Mode.IsNull() {
				*mode60 = shared.InputFilePqMode(r.InputFile.Pq.Mode.ValueString())
			} else {
				mode60 = nil
			}
			maxBufferSize50 := new(float64)
			if !r.InputFile.Pq.MaxBufferSize.IsUnknown() && !r.InputFile.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize50 = r.InputFile.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize50 = nil
			}
			commitFrequency47 := new(float64)
			if !r.InputFile.Pq.CommitFrequency.IsUnknown() && !r.InputFile.Pq.CommitFrequency.IsNull() {
				*commitFrequency47 = r.InputFile.Pq.CommitFrequency.ValueFloat64()
			} else {
				commitFrequency47 = nil
			}
			maxFileSize47 := new(string)
			if !r.InputFile.Pq.MaxFileSize.IsUnknown() && !r.InputFile.Pq.MaxFileSize.IsNull() {
				*maxFileSize47 = r.InputFile.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize47 = nil
			}
			maxSize47 := new(string)
			if !r.InputFile.Pq.MaxSize.IsUnknown() && !r.InputFile.Pq.MaxSize.IsNull() {
				*maxSize47 = r.InputFile.Pq.MaxSize.ValueString()
			} else {
				maxSize47 = nil
			}
			path48 := new(string)
			if !r.InputFile.Pq.Path.IsUnknown() && !r.InputFile.Pq.Path.IsNull() {
				*path48 = r.InputFile.Pq.Path.ValueString()
			} else {
				path48 = nil
			}
			compress54 := new(shared.InputFileCompression)
			if !r.InputFile.Pq.Compress.IsUnknown() && !r.InputFile.Pq.Compress.IsNull() {
				*compress54 = shared.InputFileCompression(r.InputFile.Pq.Compress.ValueString())
			} else {
				compress54 = nil
			}
			pq47 = &shared.InputFilePq{
				Mode:            mode60,
		...
		mode61 := new(shared.InputFileMode)
		if !r.InputFile.Mode.IsUnknown() && !r.InputFile.Mode.IsNull() {
			*mode61 = shared.InputFileMode(r.InputFile.Mode.ValueString())
		} else {
			mode61 = nil
		}
		...
		metadata51 := make([]shared.InputFileMetadatum, 0, len(r.InputFile.Metadata))
		for metadataIndex50 := range r.InputFile.Metadata {
			var name70 string
			name70 = r.InputFile.Metadata[metadataIndex50].Name.ValueString()

			var value65 string
			value65 = r.InputFile.Metadata[metadataIndex50].Value.ValueString()

			metadata51 = append(metadata51, shared.InputFileMetadatum{
				Name:  name70,
				Value: value65,
			})
		}
		...
		if !r.InputFile.Description.IsUnknown() && !r.InputFile.Description.IsNull() {
			*description56 = r.InputFile.Description.ValueString()
		} else {
			description56 = nil
		}
		path49 := new(string)
		if !r.InputFile.Path.IsUnknown() && !r.InputFile.Path.IsNull() {
			*path49 = r.InputFile.Path.ValueString()
		} else {
			path49 = nil
		}
		depth := new(float64)
	...
	if r.InputTCP != nil {
		...
		if !r.InputTCP.ID.IsUnknown() && !r.InputTCP.ID.IsNull() {
			*id48 = r.InputTCP.ID.ValueString()
		} else {
			id48 = nil
		}
		typeVar52 := new(shared.InputTCPType)
		if !r.InputTCP.Type.IsUnknown() && !r.InputTCP.Type.IsNull() {
			*typeVar52 = shared.InputTCPType(r.InputTCP.Type.ValueString())
		} else {
			typeVar52 = nil
		}
		disabled86 := new(bool)
		if !r.InputTCP.Disabled.IsUnknown() && !r.InputTCP.Disabled.IsNull() {
			*disabled86 = r.InputTCP.Disabled.ValueBool()
		} else {
			disabled86 = nil
		}
		pipeline96 := new(string)
		if !r.InputTCP.Pipeline.IsUnknown() && !r.InputTCP.Pipeline.IsNull() {
			*pipeline96 = r.InputTCP.Pipeline.ValueString()
		} else {
			pipeline96 = nil
		}
		sendToRoutes48 := new(bool)
		if !r.InputTCP.SendToRoutes.IsUnknown() && !r.InputTCP.SendToRoutes.IsNull() {
			*sendToRoutes48 = r.InputTCP.SendToRoutes.ValueBool()
		} else {
			sendToRoutes48 = nil
		}
		environment48 := new(string)
		if !r.InputTCP.Environment.IsUnknown() && !r.InputTCP.Environment.IsNull() {
			*environment48 = r.InputTCP.Environment.ValueString()
		} else {
			environment48 = nil
		}
		pqEnabled48 := new(bool)
		if !r.InputTCP.PqEnabled.IsUnknown() && !r.InputTCP.PqEnabled.IsNull() {
			*pqEnabled48 = r.InputTCP.PqEnabled.ValueBool()
		} else {
			pqEnabled48 = nil
		}
		streamtags48 := make([]string, 0, len(r.InputTCP.Streamtags))
		for streamtagsIndex48 := range r.InputTCP.Streamtags {
			streamtags48 = append(streamtags48, r.InputTCP.Streamtags[streamtagsIndex48].ValueString())
		}
		connections48 := make([]shared.InputTCPConnection, 0, len(r.InputTCP.Connections))
		for connectionsIndex48 := range r.InputTCP.Connections {
			pipeline97 := new(string)
			if !r.InputTCP.Connections[connectionsIndex48].Pipeline.IsUnknown() && !r.InputTCP.Connections[connectionsIndex48].Pipeline.IsNull() {
				*pipeline97 = r.InputTCP.Connections[connectionsIndex48].Pipeline.ValueString()
			} else {
				pipeline97 = nil
			}
			var output49 string
			output49 = r.InputTCP.Connections[connectionsIndex48].Output.ValueString()

			connections48 = append(connections48, shared.InputTCPConnection{
				Pipeline: pipeline97,
				Output:   output49,
			})
		}
		var pq48 *shared.InputTCPPq
		if r.InputTCP.Pq != nil {
			mode62 := new(shared.InputTCPMode)
			if !r.InputTCP.Pq.Mode.IsUnknown() && !r.InputTCP.Pq.Mode.IsNull() {
				*mode62 = shared.InputTCPMode(r.InputTCP.Pq.Mode.ValueString())
			} else {
				mode62 = nil
			}
			maxBufferSize51 := new(float64)
			if !r.InputTCP.Pq.MaxBufferSize.IsUnknown() && !r.InputTCP.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize51 = r.InputTCP.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize51 = nil
			}
			commitFrequency48 := new(float64)
			if !r.InputTCP.Pq.CommitFrequency.IsUnknown() && !r.InputTCP.Pq.CommitFrequency.IsNull() {
				*commitFrequency48 = r.InputTCP.Pq.CommitFrequency.ValueFloat64()
			} else {
				commitFrequency48 = nil
			}
			maxFileSize48 := new(string)
			if !r.InputTCP.Pq.MaxFileSize.IsUnknown() && !r.InputTCP.Pq.MaxFileSize.IsNull() {
				*maxFileSize48 = r.InputTCP.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize48 = nil
			}
			maxSize48 := new(string)
			if !r.InputTCP.Pq.MaxSize.IsUnknown() && !r.InputTCP.Pq.MaxSize.IsNull() {
				*maxSize48 = r.InputTCP.Pq.MaxSize.ValueString()
			} else {
				maxSize48 = nil
			}
			path50 := new(string)
			if !r.InputTCP.Pq.Path.IsUnknown() && !r.InputTCP.Pq.Path.IsNull() {
				*path50 = r.InputTCP.Pq.Path.ValueString()
			} else {
				path50 = nil
			}
			compress55 := new(shared.InputTCPCompression)
			if !r.InputTCP.Pq.Compress.IsUnknown() && !r.InputTCP.Pq.Compress.IsNull() {
				*compress55 = shared.InputTCPCompression(r.InputTCP.Pq.Compress.ValueString())
			} else {
				compress55 = nil
			}
			pq48 = &shared.InputTCPPq{
				Mode:            mode62,
		...
		if !r.InputTCP.Host.IsUnknown() && !r.InputTCP.Host.IsNull() {
			*host22 = r.InputTCP.Host.ValueString()
		} else {
			host22 = nil
		}
		var port18 float64
		...
		if r.InputTCP.TLS != nil {
			...
			if !r.InputTCP.TLS.RejectUnauthorized.IsUnknown() && !r.InputTCP.TLS.RejectUnauthorized.IsNull() {
				_ = json.Unmarshal([]byte(r.InputTCP.TLS.RejectUnauthorized.ValueString()), &rejectUnauthorized36)
			}
			var commonNameRegex18 interface{}
			if !r.InputTCP.TLS.CommonNameRegex.IsUnknown() && !r.InputTCP.TLS.CommonNameRegex.IsNull() {
				_ = json.Unmarshal([]byte(r.InputTCP.TLS.CommonNameRegex.ValueString()), &commonNameRegex18)
			}
			minVersion24 := new(shared.InputTCPMinimumTLSVersion)
			if !r.InputTCP.TLS.MinVersion.IsUnknown() && !r.InputTCP.TLS.MinVersion.IsNull() {
				*minVersion24 = shared.InputTCPMinimumTLSVersion(r.InputTCP.TLS.MinVersion.ValueString())
			} else {
				minVersion24 = nil
			}
			maxVersion24 := new(shared.InputTCPMaximumTLSVersion)
			if !r.InputTCP.TLS.MaxVersion.IsUnknown() && !r.InputTCP.TLS.MaxVersion.IsNull() {
				*maxVersion24 = shared.InputTCPMaximumTLSVersion(r.InputTCP.TLS.MaxVersion.ValueString())
			} else {
				maxVersion24 = nil
			}
			tls25 = &shared.InputTCPTLSSettingsServerSide{
				Disabled:           disabled87,
		...
		if !r.InputTCP.SocketEndingMaxWait.IsUnknown() && !r.InputTCP.SocketEndingMaxWait.IsNull() {
			*socketEndingMaxWait4 = r.InputTCP.SocketEndingMaxWait.ValueFloat64()
		} else {
		...
		if !r.InputTCP.SocketMaxLifespan.IsUnknown() && !r.InputTCP.SocketMaxLifespan.IsNull() {
			*socketMaxLifespan4 = r.InputTCP.SocketMaxLifespan.ValueFloat64()
		} else {
		...
		if !r.InputTCP.EnableProxyHeader.IsUnknown() && !r.InputTCP.EnableProxyHeader.IsNull() {
			*enableProxyHeader17 = r.InputTCP.EnableProxyHeader.ValueBool()
		} else {
			enableProxyHeader17 = nil
		}
		metadata52 := make([]shared.InputTCPMetadatum, 0, len(r.InputTCP.Metadata))
		for metadataIndex51 := range r.InputTCP.Metadata {
			var name71 string
			name71 = r.InputTCP.Metadata[metadataIndex51].Name.ValueString()

			var value66 string
			value66 = r.InputTCP.Metadata[metadataIndex51].Value.ValueString()

			metadata52 = append(metadata52, shared.InputTCPMetadatum{
				Name:  name71,
				Value: value66,
			})
		}
		...
		if r.InputTCP.Preprocess != nil {
			...
			if !r.InputTCP.Preprocess.Disabled.IsUnknown() && !r.InputTCP.Preprocess.Disabled.IsNull() {
				*disabled88 = r.InputTCP.Preprocess.Disabled.ValueBool()
			} else {
				disabled88 = nil
			}
			command5 := new(string)
		...
		if !r.InputTCP.Description.IsUnknown() && !r.InputTCP.Description.IsNull() {
			*description57 = r.InputTCP.Description.ValueString()
		} else {
			description57 = nil
		}
	...
	if r.InputAppscope != nil {
		var id49 string
		id49 = r.InputAppscope.ID.ValueString()

		typeVar53 := shared.InputAppscopeType(r.InputAppscope.Type.ValueString())
		disabled89 := new(bool)
		if !r.InputAppscope.Disabled.IsUnknown() && !r.InputAppscope.Disabled.IsNull() {
			*disabled89 = r.InputAppscope.Disabled.ValueBool()
		} else {
			disabled89 = nil
		}
		pipeline98 := new(string)
		if !r.InputAppscope.Pipeline.IsUnknown() && !r.InputAppscope.Pipeline.IsNull() {
			*pipeline98 = r.InputAppscope.Pipeline.ValueString()
		} else {
			pipeline98 = nil
		}
		sendToRoutes49 := new(bool)
		if !r.InputAppscope.SendToRoutes.IsUnknown() && !r.InputAppscope.SendToRoutes.IsNull() {
			*sendToRoutes49 = r.InputAppscope.SendToRoutes.ValueBool()
		} else {
			sendToRoutes49 = nil
		}
		environment49 := new(string)
		if !r.InputAppscope.Environment.IsUnknown() && !r.InputAppscope.Environment.IsNull() {
			*environment49 = r.InputAppscope.Environment.ValueString()
		} else {
			environment49 = nil
		}
		pqEnabled49 := new(bool)
		if !r.InputAppscope.PqEnabled.IsUnknown() && !r.InputAppscope.PqEnabled.IsNull() {
			*pqEnabled49 = r.InputAppscope.PqEnabled.ValueBool()
		} else {
			pqEnabled49 = nil
		}
		streamtags49 := make([]string, 0, len(r.InputAppscope.Streamtags))
		for streamtagsIndex49 := range r.InputAppscope.Streamtags {
			streamtags49 = append(streamtags49, r.InputAppscope.Streamtags[streamtagsIndex49].ValueString())
		}
		connections49 := make([]shared.InputAppscopeConnection, 0, len(r.InputAppscope.Connections))
		for connectionsIndex49 := range r.InputAppscope.Connections {
			pipeline99 := new(string)
			if !r.InputAppscope.Connections[connectionsIndex49].Pipeline.IsUnknown() && !r.InputAppscope.Connections[connectionsIndex49].Pipeline.IsNull() {
				*pipeline99 = r.InputAppscope.Connections[connectionsIndex49].Pipeline.ValueString()
			} else {
				pipeline99 = nil
			}
			var output50 string
			output50 = r.InputAppscope.Connections[connectionsIndex49].Output.ValueString()

			connections49 = append(connections49, shared.InputAppscopeConnection{
				Pipeline: pipeline99,
				Output:   output50,
			})
		}
		var pq49 *shared.InputAppscopePq
		if r.InputAppscope.Pq != nil {
			mode63 := new(shared.InputAppscopeMode)
			if !r.InputAppscope.Pq.Mode.IsUnknown() && !r.InputAppscope.Pq.Mode.IsNull() {
				*mode63 = shared.InputAppscopeMode(r.InputAppscope.Pq.Mode.ValueString())
			} else {
				mode63 = nil
			}
			maxBufferSize52 := new(float64)
			if !r.InputAppscope.Pq.MaxBufferSize.IsUnknown() && !r.InputAppscope.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize52 = r.InputAppscope.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize52 = nil
			}
			commitFrequency49 := new(float64)
			if !r.InputAppscope.Pq.CommitFrequency.IsUnknown() && !r.InputAppscope.Pq.CommitFrequency.IsNull() {
				*commitFrequency49 = r.InputAppscope.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputAppscope.Pq.MaxFileSize.IsUnknown() && !r.InputAppscope.Pq.MaxFileSize.IsNull() {
				*maxFileSize49 = r.InputAppscope.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize49 = nil
			}
			maxSize49 := new(string)
			if !r.InputAppscope.Pq.MaxSize.IsUnknown() && !r.InputAppscope.Pq.MaxSize.IsNull() {
				*maxSize49 = r.InputAppscope.Pq.MaxSize.ValueString()
			} else {
				maxSize49 = nil
			}
			path51 := new(string)
			if !r.InputAppscope.Pq.Path.IsUnknown() && !r.InputAppscope.Pq.Path.IsNull() {
				*path51 = r.InputAppscope.Pq.Path.ValueString()
			} else {
				path51 = nil
			}
			compress56 := new(shared.InputAppscopeCompression)
			if !r.InputAppscope.Pq.Compress.IsUnknown() && !r.InputAppscope.Pq.Compress.IsNull() {
				*compress56 = shared.InputAppscopeCompression(r.InputAppscope.Pq.Compress.ValueString())
			} else {
				compress56 = nil
			}
			pq49 = &shared.InputAppscopePq{
				Mode:            mode63,
		...
		if !r.InputAppscope.IPWhitelistRegex.IsUnknown() && !r.InputAppscope.IPWhitelistRegex.IsNull() {
			*ipWhitelistRegex6 = r.InputAppscope.IPWhitelistRegex.ValueString()
		} else {
		...
		if !r.InputAppscope.MaxActiveCxn.IsUnknown() && !r.InputAppscope.MaxActiveCxn.IsNull() {
			*maxActiveCxn7 = r.InputAppscope.MaxActiveCxn.ValueFloat64()
		} else {
			maxActiveCxn7 = nil
		}
		socketIdleTimeout5 := new(float64)
		if !r.InputAppscope.SocketIdleTimeout.IsUnknown() && !r.InputAppscope.SocketIdleTimeout.IsNull() {
			*socketIdleTimeout5 = r.InputAppscope.SocketIdleTimeout.ValueFloat64()
		} else {
		...
		if !r.InputAppscope.SocketEndingMaxWait.IsUnknown() && !r.InputAppscope.SocketEndingMaxWait.IsNull() {
			*socketEndingMaxWait5 = r.InputAppscope.SocketEndingMaxWait.ValueFloat64()
		} else {
		...
		if !r.InputAppscope.SocketMaxLifespan.IsUnknown() && !r.InputAppscope.SocketMaxLifespan.IsNull() {
			*socketMaxLifespan5 = r.InputAppscope.SocketMaxLifespan.ValueFloat64()
		} else {
		...
		if !r.InputAppscope.EnableProxyHeader.IsUnknown() && !r.InputAppscope.EnableProxyHeader.IsNull() {
			*enableProxyHeader18 = r.InputAppscope.EnableProxyHeader.ValueBool()
		} else {
			enableProxyHeader18 = nil
		}
		metadata53 := make([]shared.InputAppscopeMetadatum, 0, len(r.InputAppscope.Metadata))
		for metadataIndex52 := range r.InputAppscope.Metadata {
			var name72 string
			name72 = r.InputAppscope.Metadata[metadataIndex52].Name.ValueString()

			var value67 string
			value67 = r.InputAppscope.Metadata[metadataIndex52].Value.ValueString()

			metadata53 = append(metadata53, shared.InputAppscopeMetadatum{
				Name:  name72,
				Value: value67,
			})
		}
		...
		if r.InputAppscope.Persistence != nil {
			...
			compress57 := new(shared.InputAppscopeDataCompressionFormat)
			if !r.InputAppscope.Persistence.Compress.IsUnknown() && !r.InputAppscope.Persistence.Compress.IsNull() {
				*compress57 = shared.InputAppscopeDataCompressionFormat(r.InputAppscope.Persistence.Compress.ValueString())
			} else {
				compress57 = nil
			}
		...
		if !r.InputAppscope.Description.IsUnknown() && !r.InputAppscope.Description.IsNull() {
			*description58 = r.InputAppscope.Description.ValueString()
		} else {
			description58 = nil
		}
		host23 := new(string)
		if !r.InputAppscope.Host.IsUnknown() && !r.InputAppscope.Host.IsNull() {
			*host23 = r.InputAppscope.Host.ValueString()
		} else {
			host23 = nil
		}
		port19 := new(float64)
		...
		if r.InputAppscope.TLS != nil {
			...
			if !r.InputAppscope.TLS.RejectUnauthorized.IsUnknown() && !r.InputAppscope.TLS.RejectUnauthorized.IsNull() {
				_ = json.Unmarshal([]byte(r.InputAppscope.TLS.RejectUnauthorized.ValueString()), &rejectUnauthorized37)
			}
			...
			if !r.InputAppscope.TLS.CommonNameRegex.IsUnknown() && !r.InputAppscope.TLS.CommonNameRegex.IsNull() {
				_ = json.Unmarshal([]byte(r.InputAppscope.TLS.CommonNameRegex.ValueString()), &commonNameRegex19)
			}
			minVersion25 := new(shared.InputAppscopeMinimumTLSVersion)
			if !r.InputAppscope.TLS.MinVersion.IsUnknown() && !r.InputAppscope.TLS.MinVersion.IsNull() {
				*minVersion25 = shared.InputAppscopeMinimumTLSVersion(r.InputAppscope.TLS.MinVersion.ValueString())
			} else {
				minVersion25 = nil
			}
			maxVersion25 := new(shared.InputAppscopeMaximumTLSVersion)
			if !r.InputAppscope.TLS.MaxVersion.IsUnknown() && !r.InputAppscope.TLS.MaxVersion.IsNull() {
				*maxVersion25 = shared.InputAppscopeMaximumTLSVersion(r.InputAppscope.TLS.MaxVersion.ValueString())
			} else {
				maxVersion25 = nil
			}
			tls26 = &shared.InputAppscopeTLSSettingsServerSide{
				Disabled:           disabled90,
	...
	if r.InputWef != nil {
		...
		if !r.InputWef.ID.IsUnknown() && !r.InputWef.ID.IsNull() {
			*id50 = r.InputWef.ID.ValueString()
		} else {
			id50 = nil
		}
		typeVar54 := new(shared.InputWefType)
		if !r.InputWef.Type.IsUnknown() && !r.InputWef.Type.IsNull() {
			*typeVar54 = shared.InputWefType(r.InputWef.Type.ValueString())
		} else {
			typeVar54 = nil
		}
		disabled91 := new(bool)
		if !r.InputWef.Disabled.IsUnknown() && !r.InputWef.Disabled.IsNull() {
			*disabled91 = r.InputWef.Disabled.ValueBool()
		} else {
			disabled91 = nil
		}
		pipeline100 := new(string)
		if !r.InputWef.Pipeline.IsUnknown() && !r.InputWef.Pipeline.IsNull() {
			*pipeline100 = r.InputWef.Pipeline.ValueString()
		} else {
			pipeline100 = nil
		}
		sendToRoutes50 := new(bool)
		if !r.InputWef.SendToRoutes.IsUnknown() && !r.InputWef.SendToRoutes.IsNull() {
			*sendToRoutes50 = r.InputWef.SendToRoutes.ValueBool()
		} else {
			sendToRoutes50 = nil
		}
		environment50 := new(string)
		if !r.InputWef.Environment.IsUnknown() && !r.InputWef.Environment.IsNull() {
			*environment50 = r.InputWef.Environment.ValueString()
		} else {
			environment50 = nil
		}
		pqEnabled50 := new(bool)
		if !r.InputWef.PqEnabled.IsUnknown() && !r.InputWef.PqEnabled.IsNull() {
			*pqEnabled50 = r.InputWef.PqEnabled.ValueBool()
		} else {
			pqEnabled50 = nil
		}
		streamtags50 := make([]string, 0, len(r.InputWef.Streamtags))
		for streamtagsIndex50 := range r.InputWef.Streamtags {
			streamtags50 = append(streamtags50, r.InputWef.Streamtags[streamtagsIndex50].ValueString())
		}
		connections50 := make([]shared.InputWefConnection, 0, len(r.InputWef.Connections))
		for connectionsIndex50 := range r.InputWef.Connections {
			pipeline101 := new(string)
			if !r.InputWef.Connections[connectionsIndex50].Pipeline.IsUnknown() && !r.InputWef.Connections[connectionsIndex50].Pipeline.IsNull() {
				*pipeline101 = r.InputWef.Connections[connectionsIndex50].Pipeline.ValueString()
			} else {
				pipeline101 = nil
			}
			var output51 string
			output51 = r.InputWef.Connections[connectionsIndex50].Output.ValueString()

			connections50 = append(connections50, shared.InputWefConnection{
				Pipeline: pipeline101,
				Output:   output51,
			})
		}
		var pq50 *shared.InputWefPq
		if r.InputWef.Pq != nil {
			mode64 := new(shared.InputWefMode)
			if !r.InputWef.Pq.Mode.IsUnknown() && !r.InputWef.Pq.Mode.IsNull() {
				*mode64 = shared.InputWefMode(r.InputWef.Pq.Mode.ValueString())
			} else {
				mode64 = nil
			}
			maxBufferSize53 := new(float64)
			if !r.InputWef.Pq.MaxBufferSize.IsUnknown() && !r.InputWef.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize53 = r.InputWef.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize53 = nil
			}
			commitFrequency50 := new(float64)
			if !r.InputWef.Pq.CommitFrequency.IsUnknown() && !r.InputWef.Pq.CommitFrequency.IsNull() {
				*commitFrequency50 = r.InputWef.Pq.CommitFrequency.ValueFloat64()
			} else {
				commitFrequency50 = nil
			}
			maxFileSize50 := new(string)
			if !r.InputWef.Pq.MaxFileSize.IsUnknown() && !r.InputWef.Pq.MaxFileSize.IsNull() {
				*maxFileSize50 = r.InputWef.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize50 = nil
			}
			maxSize50 := new(string)
			if !r.InputWef.Pq.MaxSize.IsUnknown() && !r.InputWef.Pq.MaxSize.IsNull() {
				*maxSize50 = r.InputWef.Pq.MaxSize.ValueString()
			} else {
				maxSize50 = nil
			}
			path52 := new(string)
			if !r.InputWef.Pq.Path.IsUnknown() && !r.InputWef.Pq.Path.IsNull() {
				*path52 = r.InputWef.Pq.Path.ValueString()
			} else {
				path52 = nil
			}
			compress58 := new(shared.InputWefCompression)
			if !r.InputWef.Pq.Compress.IsUnknown() && !r.InputWef.Pq.Compress.IsNull() {
				*compress58 = shared.InputWefCompression(r.InputWef.Pq.Compress.ValueString())
			} else {
				compress58 = nil
			}
			pq50 = &shared.InputWefPq{
				Mode:            mode64,
		...
		if !r.InputWef.Host.IsUnknown() && !r.InputWef.Host.IsNull() {
			*host24 = r.InputWef.Host.ValueString()
		} else {
			host24 = nil
		}
		port20 := new(float64)
		...
		var tls27 *shared.MTLSSettings
		if r.InputWef.TLS != nil {
			disabled92 := new(bool)
			if !r.InputWef.TLS.Disabled.IsUnknown() && !r.InputWef.TLS.Disabled.IsNull() {
				*disabled92 = r.InputWef.TLS.Disabled.ValueBool()
			} else {
				disabled92 = nil
			}
			rejectUnauthorized38 := new(bool)
			if !r.InputWef.TLS.RejectUnauthorized.IsUnknown() && !r.InputWef.TLS.RejectUnauthorized.IsNull() {
				*rejectUnauthorized38 = r.InputWef.TLS.RejectUnauthorized.ValueBool()
			} else {
				rejectUnauthorized38 = nil
			}
			requestCert20 := new(bool)
			if !r.InputWef.TLS.RequestCert.IsUnknown() && !r.InputWef.TLS.RequestCert.IsNull() {
				*requestCert20 = r.InputWef.TLS.RequestCert.ValueBool()
			} else {
				requestCert20 = nil
			}
			certificateName28 := new(string)
			if !r.InputWef.TLS.CertificateName.IsUnknown() && !r.InputWef.TLS.CertificateName.IsNull() {
				*certificateName28 = r.InputWef.TLS.CertificateName.ValueString()
			} else {
				certificateName28 = nil
			}
			var privKeyPath27 string
			privKeyPath27 = r.InputWef.TLS.PrivKeyPath.ValueString()

			passphrase26 := new(string)
			if !r.InputWef.TLS.Passphrase.IsUnknown() && !r.InputWef.TLS.Passphrase.IsNull() {
				*passphrase26 = r.InputWef.TLS.Passphrase.ValueString()
			} else {
				passphrase26 = nil
			}
			var certPath27 string
			certPath27 = r.InputWef.TLS.CertPath.ValueString()

			var caPath26 string
			caPath26 = r.InputWef.TLS.CaPath.ValueString()

			commonNameRegex20 := new(string)
			if !r.InputWef.TLS.CommonNameRegex.IsUnknown() && !r.InputWef.TLS.CommonNameRegex.IsNull() {
				*commonNameRegex20 = r.InputWef.TLS.CommonNameRegex.ValueString()
			} else {
				commonNameRegex20 = nil
			}
			minVersion26 := new(shared.InputWefMinimumTLSVersion)
			if !r.InputWef.TLS.MinVersion.IsUnknown() && !r.InputWef.TLS.MinVersion.IsNull() {
				*minVersion26 = shared.InputWefMinimumTLSVersion(r.InputWef.TLS.MinVersion.ValueString())
			} else {
				minVersion26 = nil
			}
			maxVersion26 := new(shared.InputWefMaximumTLSVersion)
			if !r.InputWef.TLS.MaxVersion.IsUnknown() && !r.InputWef.TLS.MaxVersion.IsNull() {
				*maxVersion26 = shared.InputWefMaximumTLSVersion(r.InputWef.TLS.MaxVersion.ValueString())
			} else {
				maxVersion26 = nil
			}
			ocspCheck := new(bool)
		...
		if !r.InputWef.EnableProxyHeader.IsUnknown() && !r.InputWef.EnableProxyHeader.IsNull() {
			*enableProxyHeader19 = r.InputWef.EnableProxyHeader.ValueBool()
		} else {
		...
		for subscriptionsIndex := range r.InputWef.Subscriptions {
			var id51 string
			id51 = r.InputWef.Subscriptions[subscriptionsIndex].ID.ValueString()
			...
			if !r.InputWef.Subscriptions[subscriptionsIndex].Compress.IsUnknown() && !r.InputWef.Subscriptions[subscriptionsIndex].Compress.IsNull() {
				*compress59 = r.InputWef.Subscriptions[subscriptionsIndex].Compress.ValueBool()
			} else {
				compress59 = nil
			}
			...
			metadata54 := make([]shared.SubscriptionMetadatum, 0, len(r.InputWef.Subscriptions[subscriptionsIndex].Metadata))
			for metadataIndex53 := range r.InputWef.Subscriptions[subscriptionsIndex].Metadata {
				var name73 string
				name73 = r.InputWef.Subscriptions[subscriptionsIndex].Metadata[metadataIndex53].Name.ValueString()

				var value68 string
				value68 = r.InputWef.Subscriptions[subscriptionsIndex].Metadata[metadataIndex53].Value.ValueString()

				metadata54 = append(metadata54, shared.SubscriptionMetadatum{
					Name:  name73,
					Value: value68,
				})
			}
		...
		metadata55 := make([]shared.InputWefMetadatum, 0, len(r.InputWef.Metadata))
		for metadataIndex54 := range r.InputWef.Metadata {
			var name74 string
			name74 = r.InputWef.Metadata[metadataIndex54].Name.ValueString()

			var value69 string
			value69 = r.InputWef.Metadata[metadataIndex54].Value.ValueString()

			metadata55 = append(metadata55, shared.InputWefMetadatum{
				Name:  name74,
				Value: value69,
			})
		}
		...
		if !r.InputWef.Description.IsUnknown() && !r.InputWef.Description.IsNull() {
			*description59 = r.InputWef.Description.ValueString()
		} else {
			description59 = nil
		}
	...
	if r.InputWinEventLogs != nil {
		...
		typeVar55 := shared.InputWinEventLogsType(r.InputWinEventLogs.Type.ValueString())
		disabled93 := new(bool)
		if !r.InputWinEventLogs.Disabled.IsUnknown() && !r.InputWinEventLogs.Disabled.IsNull() {
			*disabled93 = r.InputWinEventLogs.Disabled.ValueBool()
		} else {
			disabled93 = nil
		}
		pipeline102 := new(string)
		if !r.InputWinEventLogs.Pipeline.IsUnknown() && !r.InputWinEventLogs.Pipeline.IsNull() {
			*pipeline102 = r.InputWinEventLogs.Pipeline.ValueString()
		} else {
			pipeline102 = nil
		}
		sendToRoutes51 := new(bool)
		if !r.InputWinEventLogs.SendToRoutes.IsUnknown() && !r.InputWinEventLogs.SendToRoutes.IsNull() {
			*sendToRoutes51 = r.InputWinEventLogs.SendToRoutes.ValueBool()
		} else {
			sendToRoutes51 = nil
		}
		environment51 := new(string)
		if !r.InputWinEventLogs.Environment.IsUnknown() && !r.InputWinEventLogs.Environment.IsNull() {
			*environment51 = r.InputWinEventLogs.Environment.ValueString()
		} else {
			environment51 = nil
		}
		pqEnabled51 := new(bool)
		if !r.InputWinEventLogs.PqEnabled.IsUnknown() && !r.InputWinEventLogs.PqEnabled.IsNull() {
			*pqEnabled51 = r.InputWinEventLogs.PqEnabled.ValueBool()
		} else {
			pqEnabled51 = nil
		}
		streamtags51 := make([]string, 0, len(r.InputWinEventLogs.Streamtags))
		for streamtagsIndex51 := range r.InputWinEventLogs.Streamtags {
			streamtags51 = append(streamtags51, r.InputWinEventLogs.Streamtags[streamtagsIndex51].ValueString())
		}
		connections51 := make([]shared.InputWinEventLogsConnection, 0, len(r.InputWinEventLogs.Connections))
		for connectionsIndex51 := range r.InputWinEventLogs.Connections {
			pipeline103 := new(string)
			if !r.InputWinEventLogs.Connections[connectionsIndex51].Pipeline.IsUnknown() && !r.InputWinEventLogs.Connections[connectionsIndex51].Pipeline.IsNull() {
				*pipeline103 = r.InputWinEventLogs.Connections[connectionsIndex51].Pipeline.ValueString()
			} else {
				pipeline103 = nil
			}
			var output52 string
			output52 = r.InputWinEventLogs.Connections[connectionsIndex51].Output.ValueString()

			connections51 = append(connections51, shared.InputWinEventLogsConnection{
				Pipeline: pipeline103,
				Output:   output52,
			})
		}
		var pq51 *shared.InputWinEventLogsPq
		if r.InputWinEventLogs.Pq != nil {
			mode65 := new(shared.InputWinEventLogsMode)
			if !r.InputWinEventLogs.Pq.Mode.IsUnknown() && !r.InputWinEventLogs.Pq.Mode.IsNull() {
				*mode65 = shared.InputWinEventLogsMode(r.InputWinEventLogs.Pq.Mode.ValueString())
			} else {
				mode65 = nil
			}
			maxBufferSize54 := new(float64)
			if !r.InputWinEventLogs.Pq.MaxBufferSize.IsUnknown() && !r.InputWinEventLogs.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize54 = r.InputWinEventLogs.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize54 = nil
			}
			...
			if !r.InputWinEventLogs.Pq.CommitFrequency.IsUnknown() && !r.InputWinEventLogs.Pq.CommitFrequency.IsNull() {
				*commitFrequency51 = r.InputWinEventLogs.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputWinEventLogs.Pq.MaxFileSize.IsUnknown() && !r.InputWinEventLogs.Pq.MaxFileSize.IsNull() {
				*maxFileSize51 = r.InputWinEventLogs.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize51 = nil
			}
			maxSize51 := new(string)
			if !r.InputWinEventLogs.Pq.MaxSize.IsUnknown() && !r.InputWinEventLogs.Pq.MaxSize.IsNull() {
				*maxSize51 = r.InputWinEventLogs.Pq.MaxSize.ValueString()
			} else {
				maxSize51 = nil
			}
			path53 := new(string)
			if !r.InputWinEventLogs.Pq.Path.IsUnknown() && !r.InputWinEventLogs.Pq.Path.IsNull() {
				*path53 = r.InputWinEventLogs.Pq.Path.ValueString()
			} else {
				path53 = nil
			}
			compress60 := new(shared.InputWinEventLogsCompression)
			if !r.InputWinEventLogs.Pq.Compress.IsUnknown() && !r.InputWinEventLogs.Pq.Compress.IsNull() {
				*compress60 = shared.InputWinEventLogsCompression(r.InputWinEventLogs.Pq.Compress.ValueString())
			} else {
				compress60 = nil
			}
			pq51 = &shared.InputWinEventLogsPq{
				Mode:            mode65,
		...
		metadata56 := make([]shared.InputWinEventLogsMetadatum, 0, len(r.InputWinEventLogs.Metadata))
		for metadataIndex55 := range r.InputWinEventLogs.Metadata {
			var name75 string
			name75 = r.InputWinEventLogs.Metadata[metadataIndex55].Name.ValueString()

			var value70 string
			value70 = r.InputWinEventLogs.Metadata[metadataIndex55].Value.ValueString()

			metadata56 = append(metadata56, shared.InputWinEventLogsMetadatum{
				Name:  name75,
				Value: value70,
			})
		}
		...
		if !r.InputWinEventLogs.Description.IsUnknown() && !r.InputWinEventLogs.Description.IsNull() {
			*description60 = r.InputWinEventLogs.Description.ValueString()
		} else {
			description60 = nil
		}
	...
	if r.InputRawUDP != nil {
		...
		typeVar56 := new(shared.InputRawUDPType)
		if !r.InputRawUDP.Type.IsUnknown() && !r.InputRawUDP.Type.IsNull() {
			*typeVar56 = shared.InputRawUDPType(r.InputRawUDP.Type.ValueString())
		} else {
			typeVar56 = nil
		}
		disabled94 := new(bool)
		if !r.InputRawUDP.Disabled.IsUnknown() && !r.InputRawUDP.Disabled.IsNull() {
			*disabled94 = r.InputRawUDP.Disabled.ValueBool()
		} else {
			disabled94 = nil
		}
		pipeline104 := new(string)
		if !r.InputRawUDP.Pipeline.IsUnknown() && !r.InputRawUDP.Pipeline.IsNull() {
			*pipeline104 = r.InputRawUDP.Pipeline.ValueString()
		} else {
			pipeline104 = nil
		}
		sendToRoutes52 := new(bool)
		if !r.InputRawUDP.SendToRoutes.IsUnknown() && !r.InputRawUDP.SendToRoutes.IsNull() {
			*sendToRoutes52 = r.InputRawUDP.SendToRoutes.ValueBool()
		} else {
			sendToRoutes52 = nil
		}
		environment52 := new(string)
		if !r.InputRawUDP.Environment.IsUnknown() && !r.InputRawUDP.Environment.IsNull() {
			*environment52 = r.InputRawUDP.Environment.ValueString()
		} else {
			environment52 = nil
		}
		pqEnabled52 := new(bool)
		if !r.InputRawUDP.PqEnabled.IsUnknown() && !r.InputRawUDP.PqEnabled.IsNull() {
			*pqEnabled52 = r.InputRawUDP.PqEnabled.ValueBool()
		} else {
			pqEnabled52 = nil
		}
		streamtags52 := make([]string, 0, len(r.InputRawUDP.Streamtags))
		for streamtagsIndex52 := range r.InputRawUDP.Streamtags {
			streamtags52 = append(streamtags52, r.InputRawUDP.Streamtags[streamtagsIndex52].ValueString())
		}
		connections52 := make([]shared.InputRawUDPConnection, 0, len(r.InputRawUDP.Connections))
		for connectionsIndex52 := range r.InputRawUDP.Connections {
			pipeline105 := new(string)
			if !r.InputRawUDP.Connections[connectionsIndex52].Pipeline.IsUnknown() && !r.InputRawUDP.Connections[connectionsIndex52].Pipeline.IsNull() {
				*pipeline105 = r.InputRawUDP.Connections[connectionsIndex52].Pipeline.ValueString()
			} else {
				pipeline105 = nil
			}
			var output53 string
			output53 = r.InputRawUDP.Connections[connectionsIndex52].Output.ValueString()

			connections52 = append(connections52, shared.InputRawUDPConnection{
				Pipeline: pipeline105,
				Output:   output53,
			})
		}
		var pq52 *shared.InputRawUDPPq
		if r.InputRawUDP.Pq != nil {
			mode66 := new(shared.InputRawUDPMode)
			if !r.InputRawUDP.Pq.Mode.IsUnknown() && !r.InputRawUDP.Pq.Mode.IsNull() {
				*mode66 = shared.InputRawUDPMode(r.InputRawUDP.Pq.Mode.ValueString())
			} else {
				mode66 = nil
			}
			maxBufferSize55 := new(float64)
			if !r.InputRawUDP.Pq.MaxBufferSize.IsUnknown() && !r.InputRawUDP.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize55 = r.InputRawUDP.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize55 = nil
			}
			commitFrequency52 := new(float64)
			if !r.InputRawUDP.Pq.CommitFrequency.IsUnknown() && !r.InputRawUDP.Pq.CommitFrequency.IsNull() {
				*commitFrequency52 = r.InputRawUDP.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputRawUDP.Pq.MaxFileSize.IsUnknown() && !r.InputRawUDP.Pq.MaxFileSize.IsNull() {
				*maxFileSize52 = r.InputRawUDP.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize52 = nil
			}
			maxSize52 := new(string)
			if !r.InputRawUDP.Pq.MaxSize.IsUnknown() && !r.InputRawUDP.Pq.MaxSize.IsNull() {
				*maxSize52 = r.InputRawUDP.Pq.MaxSize.ValueString()
			} else {
				maxSize52 = nil
			}
			path54 := new(string)
			if !r.InputRawUDP.Pq.Path.IsUnknown() && !r.InputRawUDP.Pq.Path.IsNull() {
				*path54 = r.InputRawUDP.Pq.Path.ValueString()
			} else {
				path54 = nil
			}
			compress61 := new(shared.InputRawUDPCompression)
			if !r.InputRawUDP.Pq.Compress.IsUnknown() && !r.InputRawUDP.Pq.Compress.IsNull() {
				*compress61 = shared.InputRawUDPCompression(r.InputRawUDP.Pq.Compress.ValueString())
			} else {
				compress61 = nil
			}
			pq52 = &shared.InputRawUDPPq{
				Mode:            mode66,
		...
		if !r.InputRawUDP.Host.IsUnknown() && !r.InputRawUDP.Host.IsNull() {
			*host25 = r.InputRawUDP.Host.ValueString()
		} else {
			host25 = nil
		}
		var port21 float64
		...
		if !r.InputRawUDP.MaxBufferSize.IsUnknown() && !r.InputRawUDP.MaxBufferSize.IsNull() {
			*maxBufferSize56 = r.InputRawUDP.MaxBufferSize.ValueFloat64()
		} else {
			maxBufferSize56 = nil
		}
		ipWhitelistRegex7 := new(string)
		if !r.InputRawUDP.IPWhitelistRegex.IsUnknown() && !r.InputRawUDP.IPWhitelistRegex.IsNull() {
			*ipWhitelistRegex7 = r.InputRawUDP.IPWhitelistRegex.ValueString()
		} else {
		...
		if !r.InputRawUDP.SingleMsgUDPPackets.IsUnknown() && !r.InputRawUDP.SingleMsgUDPPackets.IsNull() {
			*singleMsgUDPPackets1 = r.InputRawUDP.SingleMsgUDPPackets.ValueBool()
		} else {
		...
		if !r.InputRawUDP.UDPSocketRxBufSize.IsUnknown() && !r.InputRawUDP.UDPSocketRxBufSize.IsNull() {
			*udpSocketRxBufSize3 = r.InputRawUDP.UDPSocketRxBufSize.ValueFloat64()
		} else {
			udpSocketRxBufSize3 = nil
		}
		metadata57 := make([]shared.InputRawUDPMetadatum, 0, len(r.InputRawUDP.Metadata))
		for metadataIndex56 := range r.InputRawUDP.Metadata {
			var name76 string
			name76 = r.InputRawUDP.Metadata[metadataIndex56].Name.ValueString()

			var value71 string
			value71 = r.InputRawUDP.Metadata[metadataIndex56].Value.ValueString()

			metadata57 = append(metadata57, shared.InputRawUDPMetadatum{
				Name:  name76,
				Value: value71,
			})
		}
		...
		if !r.InputRawUDP.Description.IsUnknown() && !r.InputRawUDP.Description.IsNull() {
			*description61 = r.InputRawUDP.Description.ValueString()
		} else {
			description61 = nil
		}
	...
	if r.InputJournalFiles != nil {
		...
		typeVar57 := new(shared.InputJournalFilesType)
		if !r.InputJournalFiles.Type.IsUnknown() && !r.InputJournalFiles.Type.IsNull() {
			*typeVar57 = shared.InputJournalFilesType(r.InputJournalFiles.Type.ValueString())
		} else {
			typeVar57 = nil
		}
		disabled95 := new(bool)
		if !r.InputJournalFiles.Disabled.IsUnknown() && !r.InputJournalFiles.Disabled.IsNull() {
			*disabled95 = r.InputJournalFiles.Disabled.ValueBool()
		} else {
			disabled95 = nil
		}
		pipeline106 := new(string)
		if !r.InputJournalFiles.Pipeline.IsUnknown() && !r.InputJournalFiles.Pipeline.IsNull() {
			*pipeline106 = r.InputJournalFiles.Pipeline.ValueString()
		} else {
			pipeline106 = nil
		}
		sendToRoutes53 := new(bool)
		if !r.InputJournalFiles.SendToRoutes.IsUnknown() && !r.InputJournalFiles.SendToRoutes.IsNull() {
			*sendToRoutes53 = r.InputJournalFiles.SendToRoutes.ValueBool()
		} else {
			sendToRoutes53 = nil
		}
		environment53 := new(string)
		if !r.InputJournalFiles.Environment.IsUnknown() && !r.InputJournalFiles.Environment.IsNull() {
			*environment53 = r.InputJournalFiles.Environment.ValueString()
		} else {
			environment53 = nil
		}
		pqEnabled53 := new(bool)
		if !r.InputJournalFiles.PqEnabled.IsUnknown() && !r.InputJournalFiles.PqEnabled.IsNull() {
			*pqEnabled53 = r.InputJournalFiles.PqEnabled.ValueBool()
		} else {
			pqEnabled53 = nil
		}
		streamtags53 := make([]string, 0, len(r.InputJournalFiles.Streamtags))
		for streamtagsIndex53 := range r.InputJournalFiles.Streamtags {
			streamtags53 = append(streamtags53, r.InputJournalFiles.Streamtags[streamtagsIndex53].ValueString())
		}
		connections53 := make([]shared.InputJournalFilesConnection, 0, len(r.InputJournalFiles.Connections))
		for connectionsIndex53 := range r.InputJournalFiles.Connections {
			pipeline107 := new(string)
			if !r.InputJournalFiles.Connections[connectionsIndex53].Pipeline.IsUnknown() && !r.InputJournalFiles.Connections[connectionsIndex53].Pipeline.IsNull() {
				*pipeline107 = r.InputJournalFiles.Connections[connectionsIndex53].Pipeline.ValueString()
			} else {
				pipeline107 = nil
			}
			var output54 string
			output54 = r.InputJournalFiles.Connections[connectionsIndex53].Output.ValueString()

			connections53 = append(connections53, shared.InputJournalFilesConnection{
				Pipeline: pipeline107,
				Output:   output54,
			})
		}
		var pq53 *shared.InputJournalFilesPq
		if r.InputJournalFiles.Pq != nil {
			mode67 := new(shared.InputJournalFilesMode)
			if !r.InputJournalFiles.Pq.Mode.IsUnknown() && !r.InputJournalFiles.Pq.Mode.IsNull() {
				*mode67 = shared.InputJournalFilesMode(r.InputJournalFiles.Pq.Mode.ValueString())
			} else {
				mode67 = nil
			}
			maxBufferSize57 := new(float64)
			if !r.InputJournalFiles.Pq.MaxBufferSize.IsUnknown() && !r.InputJournalFiles.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize57 = r.InputJournalFiles.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize57 = nil
			}
			...
			if !r.InputJournalFiles.Pq.CommitFrequency.IsUnknown() && !r.InputJournalFiles.Pq.CommitFrequency.IsNull() {
				*commitFrequency53 = r.InputJournalFiles.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputJournalFiles.Pq.MaxFileSize.IsUnknown() && !r.InputJournalFiles.Pq.MaxFileSize.IsNull() {
				*maxFileSize53 = r.InputJournalFiles.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize53 = nil
			}
			maxSize53 := new(string)
			if !r.InputJournalFiles.Pq.MaxSize.IsUnknown() && !r.InputJournalFiles.Pq.MaxSize.IsNull() {
				*maxSize53 = r.InputJournalFiles.Pq.MaxSize.ValueString()
			} else {
				maxSize53 = nil
			}
			path55 := new(string)
			if !r.InputJournalFiles.Pq.Path.IsUnknown() && !r.InputJournalFiles.Pq.Path.IsNull() {
				*path55 = r.InputJournalFiles.Pq.Path.ValueString()
			} else {
				path55 = nil
			}
			compress62 := new(shared.InputJournalFilesCompression)
			if !r.InputJournalFiles.Pq.Compress.IsUnknown() && !r.InputJournalFiles.Pq.Compress.IsNull() {
				*compress62 = shared.InputJournalFilesCompression(r.InputJournalFiles.Pq.Compress.ValueString())
			} else {
				compress62 = nil
			}
			pq53 = &shared.InputJournalFilesPq{
				Mode:            mode67,
		...
		var path56 string
		path56 = r.InputJournalFiles.Path.ValueString()
		...
		for rulesIndex3 := range r.InputJournalFiles.Rules {
			...
			if !r.InputJournalFiles.Rules[rulesIndex3].Description.IsUnknown() && !r.InputJournalFiles.Rules[rulesIndex3].Description.IsNull() {
				*description62 = r.InputJournalFiles.Rules[rulesIndex3].Description.ValueString()
			} else {
				description62 = nil
			}
		...
		metadata58 := make([]shared.InputJournalFilesMetadatum, 0, len(r.InputJournalFiles.Metadata))
		for metadataIndex57 := range r.InputJournalFiles.Metadata {
			var name77 string
			name77 = r.InputJournalFiles.Metadata[metadataIndex57].Name.ValueString()

			var value72 string
			value72 = r.InputJournalFiles.Metadata[metadataIndex57].Value.ValueString()

			metadata58 = append(metadata58, shared.InputJournalFilesMetadatum{
				Name:  name77,
				Value: value72,
			})
		}
		...
		if !r.InputJournalFiles.Description.IsUnknown() && !r.InputJournalFiles.Description.IsNull() {
			*description63 = r.InputJournalFiles.Description.ValueString()
		} else {
			description63 = nil
		}
	...
	if r.InputWiz != nil {
		...
		typeVar58 := new(shared.InputWizType)
		if !r.InputWiz.Type.IsUnknown() && !r.InputWiz.Type.IsNull() {
			*typeVar58 = shared.InputWizType(r.InputWiz.Type.ValueString())
		} else {
			typeVar58 = nil
		}
		disabled96 := new(bool)
		if !r.InputWiz.Disabled.IsUnknown() && !r.InputWiz.Disabled.IsNull() {
			*disabled96 = r.InputWiz.Disabled.ValueBool()
		} else {
			disabled96 = nil
		}
		pipeline108 := new(string)
		if !r.InputWiz.Pipeline.IsUnknown() && !r.InputWiz.Pipeline.IsNull() {
			*pipeline108 = r.InputWiz.Pipeline.ValueString()
		} else {
			pipeline108 = nil
		}
		sendToRoutes54 := new(bool)
		if !r.InputWiz.SendToRoutes.IsUnknown() && !r.InputWiz.SendToRoutes.IsNull() {
			*sendToRoutes54 = r.InputWiz.SendToRoutes.ValueBool()
		} else {
			sendToRoutes54 = nil
		}
		environment54 := new(string)
		if !r.InputWiz.Environment.IsUnknown() && !r.InputWiz.Environment.IsNull() {
			*environment54 = r.InputWiz.Environment.ValueString()
		} else {
			environment54 = nil
		}
		pqEnabled54 := new(bool)
		if !r.InputWiz.PqEnabled.IsUnknown() && !r.InputWiz.PqEnabled.IsNull() {
			*pqEnabled54 = r.InputWiz.PqEnabled.ValueBool()
		} else {
			pqEnabled54 = nil
		}
		streamtags54 := make([]string, 0, len(r.InputWiz.Streamtags))
		for streamtagsIndex54 := range r.InputWiz.Streamtags {
			streamtags54 = append(streamtags54, r.InputWiz.Streamtags[streamtagsIndex54].ValueString())
		}
		connections54 := make([]shared.InputWizConnection, 0, len(r.InputWiz.Connections))
		for connectionsIndex54 := range r.InputWiz.Connections {
			pipeline109 := new(string)
			if !r.InputWiz.Connections[connectionsIndex54].Pipeline.IsUnknown() && !r.InputWiz.Connections[connectionsIndex54].Pipeline.IsNull() {
				*pipeline109 = r.InputWiz.Connections[connectionsIndex54].Pipeline.ValueString()
			} else {
				pipeline109 = nil
			}
			var output55 string
			output55 = r.InputWiz.Connections[connectionsIndex54].Output.ValueString()

			connections54 = append(connections54, shared.InputWizConnection{
				Pipeline: pipeline109,
				Output:   output55,
			})
		}
		var pq54 *shared.InputWizPq
		if r.InputWiz.Pq != nil {
			mode68 := new(shared.InputWizMode)
			if !r.InputWiz.Pq.Mode.IsUnknown() && !r.InputWiz.Pq.Mode.IsNull() {
				*mode68 = shared.InputWizMode(r.InputWiz.Pq.Mode.ValueString())
			} else {
				mode68 = nil
			}
			maxBufferSize58 := new(float64)
			if !r.InputWiz.Pq.MaxBufferSize.IsUnknown() && !r.InputWiz.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize58 = r.InputWiz.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize58 = nil
			}
			commitFrequency54 := new(float64)
			if !r.InputWiz.Pq.CommitFrequency.IsUnknown() && !r.InputWiz.Pq.CommitFrequency.IsNull() {
				*commitFrequency54 = r.InputWiz.Pq.CommitFrequency.ValueFloat64()
			} else {
				commitFrequency54 = nil
			}
			maxFileSize54 := new(string)
			if !r.InputWiz.Pq.MaxFileSize.IsUnknown() && !r.InputWiz.Pq.MaxFileSize.IsNull() {
				*maxFileSize54 = r.InputWiz.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize54 = nil
			}
			maxSize54 := new(string)
			if !r.InputWiz.Pq.MaxSize.IsUnknown() && !r.InputWiz.Pq.MaxSize.IsNull() {
				*maxSize54 = r.InputWiz.Pq.MaxSize.ValueString()
			} else {
				maxSize54 = nil
			}
			path57 := new(string)
			if !r.InputWiz.Pq.Path.IsUnknown() && !r.InputWiz.Pq.Path.IsNull() {
				*path57 = r.InputWiz.Pq.Path.ValueString()
			} else {
				path57 = nil
			}
			compress63 := new(shared.InputWizCompression)
			if !r.InputWiz.Pq.Compress.IsUnknown() && !r.InputWiz.Pq.Compress.IsNull() {
				*compress63 = shared.InputWizCompression(r.InputWiz.Pq.Compress.ValueString())
			} else {
				compress63 = nil
			}
			pq54 = &shared.InputWizPq{
				Mode:            mode68,
		...
		metadata59 := make([]shared.InputWizMetadatum, 0, len(r.InputWiz.Metadata))
		for metadataIndex58 := range r.InputWiz.Metadata {
			var name78 string
			name78 = r.InputWiz.Metadata[metadataIndex58].Name.ValueString()

			var value73 string
			value73 = r.InputWiz.Metadata[metadataIndex58].Value.ValueString()

			metadata59 = append(metadata59, shared.InputWizMetadatum{
				Name:  name78,
				Value: value73,
			})
		}
		...
		if r.InputWiz.RetryRules != nil {
			typeVar59 := new(shared.InputWizRetryType)
			if !r.InputWiz.RetryRules.Type.IsUnknown() && !r.InputWiz.RetryRules.Type.IsNull() {
				*typeVar59 = shared.InputWizRetryType(r.InputWiz.RetryRules.Type.ValueString())
			} else {
				typeVar59 = nil
			}
		...
		if !r.InputWiz.Description.IsUnknown() && !r.InputWiz.Description.IsNull() {
			*description64 = r.InputWiz.Description.ValueString()
		} else {
			description64 = nil
		}
	...
	if r.InputWizWebhook != nil {
		...
		if !r.InputWizWebhook.ID.IsUnknown() && !r.InputWizWebhook.ID.IsNull() {
			*id56 = r.InputWizWebhook.ID.ValueString()
		} else {
			id56 = nil
		}
		typeVar60 := shared.InputWizWebhookType(r.InputWizWebhook.Type.ValueString())
		disabled97 := new(bool)
		if !r.InputWizWebhook.Disabled.IsUnknown() && !r.InputWizWebhook.Disabled.IsNull() {
			*disabled97 = r.InputWizWebhook.Disabled.ValueBool()
		} else {
			disabled97 = nil
		}
		pipeline110 := new(string)
		if !r.InputWizWebhook.Pipeline.IsUnknown() && !r.InputWizWebhook.Pipeline.IsNull() {
			*pipeline110 = r.InputWizWebhook.Pipeline.ValueString()
		} else {
			pipeline110 = nil
		}
		sendToRoutes55 := new(bool)
		if !r.InputWizWebhook.SendToRoutes.IsUnknown() && !r.InputWizWebhook.SendToRoutes.IsNull() {
			*sendToRoutes55 = r.InputWizWebhook.SendToRoutes.ValueBool()
		} else {
			sendToRoutes55 = nil
		}
		environment55 := new(string)
		if !r.InputWizWebhook.Environment.IsUnknown() && !r.InputWizWebhook.Environment.IsNull() {
			*environment55 = r.InputWizWebhook.Environment.ValueString()
		} else {
			environment55 = nil
		}
		pqEnabled55 := new(bool)
		if !r.InputWizWebhook.PqEnabled.IsUnknown() && !r.InputWizWebhook.PqEnabled.IsNull() {
			*pqEnabled55 = r.InputWizWebhook.PqEnabled.ValueBool()
		} else {
			pqEnabled55 = nil
		}
		streamtags55 := make([]string, 0, len(r.InputWizWebhook.Streamtags))
		for streamtagsIndex55 := range r.InputWizWebhook.Streamtags {
			streamtags55 = append(streamtags55, r.InputWizWebhook.Streamtags[streamtagsIndex55].ValueString())
		}
		connections55 := make([]shared.InputWizWebhookConnection, 0, len(r.InputWizWebhook.Connections))
		for connectionsIndex55 := range r.InputWizWebhook.Connections {
			pipeline111 := new(string)
			if !r.InputWizWebhook.Connections[connectionsIndex55].Pipeline.IsUnknown() && !r.InputWizWebhook.Connections[connectionsIndex55].Pipeline.IsNull() {
				*pipeline111 = r.InputWizWebhook.Connections[connectionsIndex55].Pipeline.ValueString()
			} else {
				pipeline111 = nil
			}
			var output56 string
			output56 = r.InputWizWebhook.Connections[connectionsIndex55].Output.ValueString()

			connections55 = append(connections55, shared.InputWizWebhookConnection{
				Pipeline: pipeline111,
				Output:   output56,
			})
		}
		var pq55 *shared.InputWizWebhookPq
		if r.InputWizWebhook.Pq != nil {
			mode69 := new(shared.InputWizWebhookMode)
			if !r.InputWizWebhook.Pq.Mode.IsUnknown() && !r.InputWizWebhook.Pq.Mode.IsNull() {
				*mode69 = shared.InputWizWebhookMode(r.InputWizWebhook.Pq.Mode.ValueString())
			} else {
				mode69 = nil
			}
			maxBufferSize59 := new(float64)
			if !r.InputWizWebhook.Pq.MaxBufferSize.IsUnknown() && !r.InputWizWebhook.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize59 = r.InputWizWebhook.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize59 = nil
			}
			...
			if !r.InputWizWebhook.Pq.CommitFrequency.IsUnknown() && !r.InputWizWebhook.Pq.CommitFrequency.IsNull() {
				*commitFrequency55 = r.InputWizWebhook.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputWizWebhook.Pq.MaxFileSize.IsUnknown() && !r.InputWizWebhook.Pq.MaxFileSize.IsNull() {
				*maxFileSize55 = r.InputWizWebhook.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize55 = nil
			}
			maxSize55 := new(string)
			if !r.InputWizWebhook.Pq.MaxSize.IsUnknown() && !r.InputWizWebhook.Pq.MaxSize.IsNull() {
				*maxSize55 = r.InputWizWebhook.Pq.MaxSize.ValueString()
			} else {
				maxSize55 = nil
			}
			path58 := new(string)
			if !r.InputWizWebhook.Pq.Path.IsUnknown() && !r.InputWizWebhook.Pq.Path.IsNull() {
				*path58 = r.InputWizWebhook.Pq.Path.ValueString()
			} else {
				path58 = nil
			}
			compress64 := new(shared.InputWizWebhookCompression)
			if !r.InputWizWebhook.Pq.Compress.IsUnknown() && !r.InputWizWebhook.Pq.Compress.IsNull() {
				*compress64 = shared.InputWizWebhookCompression(r.InputWizWebhook.Pq.Compress.ValueString())
			} else {
				compress64 = nil
			}
		...
		if !r.InputWizWebhook.Host.IsUnknown() && !r.InputWizWebhook.Host.IsNull() {
			*host26 = r.InputWizWebhook.Host.ValueString()
		} else {
			host26 = nil
		}
		var port22 float64
		...
		if r.InputWizWebhook.TLS != nil {
			...
			if !r.InputWizWebhook.TLS.RejectUnauthorized.IsUnknown() && !r.InputWizWebhook.TLS.RejectUnauthorized.IsNull() {
				*rejectUnauthorized39 = r.InputWizWebhook.TLS.RejectUnauthorized.ValueBool()
			} else {
			...
			if !r.InputWizWebhook.TLS.CommonNameRegex.IsUnknown() && !r.InputWizWebhook.TLS.CommonNameRegex.IsNull() {
				*commonNameRegex21 = r.InputWizWebhook.TLS.CommonNameRegex.ValueString()
			} else {
			...
			if !r.InputWizWebhook.TLS.CertificateName.IsUnknown() && !r.InputWizWebhook.TLS.CertificateName.IsNull() {
				*certificateName29 = r.InputWizWebhook.TLS.CertificateName.ValueString()
			} else {
			...
			if !r.InputWizWebhook.TLS.PrivKeyPath.IsUnknown() && !r.InputWizWebhook.TLS.PrivKeyPath.IsNull() {
				*privKeyPath28 = r.InputWizWebhook.TLS.PrivKeyPath.ValueString()
			} else {
				privKeyPath28 = nil
			}
			passphrase27 := new(string)
			if !r.InputWizWebhook.TLS.Passphrase.IsUnknown() && !r.InputWizWebhook.TLS.Passphrase.IsNull() {
				*passphrase27 = r.InputWizWebhook.TLS.Passphrase.ValueString()
			} else {
				passphrase27 = nil
			}
			certPath28 := new(string)
			if !r.InputWizWebhook.TLS.CertPath.IsUnknown() && !r.InputWizWebhook.TLS.CertPath.IsNull() {
				*certPath28 = r.InputWizWebhook.TLS.CertPath.ValueString()
			} else {
				certPath28 = nil
			}
			caPath27 := new(string)
			if !r.InputWizWebhook.TLS.CaPath.IsUnknown() && !r.InputWizWebhook.TLS.CaPath.IsNull() {
				*caPath27 = r.InputWizWebhook.TLS.CaPath.ValueString()
			} else {
				caPath27 = nil
			}
			minVersion27 := new(shared.InputWizWebhookMinimumTLSVersion)
			if !r.InputWizWebhook.TLS.MinVersion.IsUnknown() && !r.InputWizWebhook.TLS.MinVersion.IsNull() {
				*minVersion27 = shared.InputWizWebhookMinimumTLSVersion(r.InputWizWebhook.TLS.MinVersion.ValueString())
			} else {
				minVersion27 = nil
			}
			maxVersion27 := new(shared.InputWizWebhookMaximumTLSVersion)
			if !r.InputWizWebhook.TLS.MaxVersion.IsUnknown() && !r.InputWizWebhook.TLS.MaxVersion.IsNull() {
				*maxVersion27 = shared.InputWizWebhookMaximumTLSVersion(r.InputWizWebhook.TLS.MaxVersion.ValueString())
			} else {
				maxVersion27 = nil
			}
			tls28 = &shared.InputWizWebhookTLSSettingsServerSide{
				Disabled:           disabled98,
		...
		if !r.InputWizWebhook.EnableProxyHeader.IsUnknown() && !r.InputWizWebhook.EnableProxyHeader.IsNull() {
			*enableProxyHeader20 = r.InputWizWebhook.EnableProxyHeader.ValueBool()
		} else {
		...
		for breakerRulesetsIndex14 := range r.InputWizWebhook.BreakerRulesets {
			breakerRulesets14 = append(breakerRulesets14, r.InputWizWebhook.BreakerRulesets[breakerRulesetsIndex14].ValueString())
		}
		staleChannelFlushMs14 := new(float64)
		if !r.InputWizWebhook.StaleChannelFlushMs.IsUnknown() && !r.InputWizWebhook.StaleChannelFlushMs.IsNull() {
			*staleChannelFlushMs14 = r.InputWizWebhook.StaleChannelFlushMs.ValueFloat64()
		} else {
			staleChannelFlushMs14 = nil
		}
		metadata60 := make([]shared.InputWizWebhookMetadatum, 0, len(r.InputWizWebhook.Metadata))
		for metadataIndex59 := range r.InputWizWebhook.Metadata {
			var name79 string
			name79 = r.InputWizWebhook.Metadata[metadataIndex59].Name.ValueString()

			var value74 string
			value74 = r.InputWizWebhook.Metadata[metadataIndex59].Value.ValueString()

			metadata60 = append(metadata60, shared.InputWizWebhookMetadatum{
				Name:  name79,
				Value: value74,
			})
		}
		allowedPaths1 := make([]string, 0, len(r.InputWizWebhook.AllowedPaths))
		for allowedPathsIndex1 := range r.InputWizWebhook.AllowedPaths {
			allowedPaths1 = append(allowedPaths1, r.InputWizWebhook.AllowedPaths[allowedPathsIndex1].ValueString())
		}
		allowedMethods1 := make([]string, 0, len(r.InputWizWebhook.AllowedMethods))
		for allowedMethodsIndex1 := range r.InputWizWebhook.AllowedMethods {
			allowedMethods1 = append(allowedMethods1, r.InputWizWebhook.AllowedMethods[allowedMethodsIndex1].ValueString())
		}
		...
		for authTokensExtIndex2 := range r.InputWizWebhook.AuthTokensExt {
			...
			if !r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Description.IsUnknown() && !r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Description.IsNull() {
				*description65 = r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Description.ValueString()
			} else {
				description65 = nil
			}
			metadata61 := make([]shared.InputWizWebhookAuthTokensExtMetadatum, 0, len(r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Metadata))
			for metadataIndex60 := range r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Metadata {
				var name80 string
				name80 = r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Metadata[metadataIndex60].Name.ValueString()

				var value75 string
				value75 = r.InputWizWebhook.AuthTokensExt[authTokensExtIndex2].Metadata[metadataIndex60].Value.ValueString()

				metadata61 = append(metadata61, shared.InputWizWebhookAuthTokensExtMetadatum{
					Name:  name80,
					Value: value75,
				})
			}
		...
		if !r.InputWizWebhook.Description.IsUnknown() && !r.InputWizWebhook.Description.IsNull() {
			*description66 = r.InputWizWebhook.Description.ValueString()
		} else {
			description66 = nil
		}
	...
	if r.InputNetflow != nil {
		...
		for streamtagsIndex56 := range r.InputNetflow.Streamtags {
			streamtags56 = append(streamtags56, r.InputNetflow.Streamtags[streamtagsIndex56].ValueString())
		}
		connections56 := make([]shared.InputNetflowConnection, 0, len(r.InputNetflow.Connections))
		for connectionsIndex56 := range r.InputNetflow.Connections {
			pipeline113 := new(string)
			if !r.InputNetflow.Connections[connectionsIndex56].Pipeline.IsUnknown() && !r.InputNetflow.Connections[connectionsIndex56].Pipeline.IsNull() {
				*pipeline113 = r.InputNetflow.Connections[connectionsIndex56].Pipeline.ValueString()
			} else {
				pipeline113 = nil
			}
			var output57 string
			output57 = r.InputNetflow.Connections[connectionsIndex56].Output.ValueString()

			connections56 = append(connections56, shared.InputNetflowConnection{
		...
		if r.InputNetflow.Pq != nil {
			...
			if !r.InputNetflow.Pq.MaxBufferSize.IsUnknown() && !r.InputNetflow.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize60 = r.InputNetflow.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize60 = nil
			}
		...
		if !r.InputNetflow.UDPSocketRxBufSize.IsUnknown() && !r.InputNetflow.UDPSocketRxBufSize.IsNull() {
			*udpSocketRxBufSize4 = r.InputNetflow.UDPSocketRxBufSize.ValueFloat64()
		} else {
		...
		for metadataIndex61 := range r.InputNetflow.Metadata {
			var name81 string
			name81 = r.InputNetflow.Metadata[metadataIndex61].Name.ValueString()

			var value76 string
			value76 = r.InputNetflow.Metadata[metadataIndex61].Value.ValueString()
	...
	if r.InputSecurityLake != nil {
		...
		for streamtagsIndex57 := range r.InputSecurityLake.Streamtags {
			streamtags57 = append(streamtags57, r.InputSecurityLake.Streamtags[streamtagsIndex57].ValueString())
		}
		connections57 := make([]shared.InputSecurityLakeConnection, 0, len(r.InputSecurityLake.Connections))
		for connectionsIndex57 := range r.InputSecurityLake.Connections {
			pipeline115 := new(string)
			if !r.InputSecurityLake.Connections[connectionsIndex57].Pipeline.IsUnknown() && !r.InputSecurityLake.Connections[connectionsIndex57].Pipeline.IsNull() {
				*pipeline115 = r.InputSecurityLake.Connections[connectionsIndex57].Pipeline.ValueString()
			} else {
				pipeline115 = nil
			}
			var output58 string
			output58 = r.InputSecurityLake.Connections[connectionsIndex57].Output.ValueString()

			connections57 = append(connections57, shared.InputSecurityLakeConnection{
		...
		if r.InputSecurityLake.Pq != nil {
			...
			if !r.InputSecurityLake.Pq.MaxBufferSize.IsUnknown() && !r.InputSecurityLake.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize61 = r.InputSecurityLake.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize61 = nil
			}
		...
		for breakerRulesetsIndex15 := range r.InputSecurityLake.BreakerRulesets {
			breakerRulesets15 = append(breakerRulesets15, r.InputSecurityLake.BreakerRulesets[breakerRulesetsIndex15].ValueString())
		}
		staleChannelFlushMs15 := new(float64)
		if !r.InputSecurityLake.StaleChannelFlushMs.IsUnknown() && !r.InputSecurityLake.StaleChannelFlushMs.IsNull() {
			*staleChannelFlushMs15 = r.InputSecurityLake.StaleChannelFlushMs.ValueFloat64()
		} else {
			staleChannelFlushMs15 = nil
		}
		...
		for metadataIndex62 := range r.InputSecurityLake.Metadata {
			var name82 string
			name82 = r.InputSecurityLake.Metadata[metadataIndex62].Name.ValueString()

			var value77 string
			value77 = r.InputSecurityLake.Metadata[metadataIndex62].Value.ValueString()
	...
	if r.InputZscalerHec != nil {
		...
		for streamtagsIndex58 := range r.InputZscalerHec.Streamtags {
			streamtags58 = append(streamtags58, r.InputZscalerHec.Streamtags[streamtagsIndex58].ValueString())
		}
		connections58 := make([]shared.InputZscalerHecConnection, 0, len(r.InputZscalerHec.Connections))
		for connectionsIndex58 := range r.InputZscalerHec.Connections {
			pipeline117 := new(string)
			if !r.InputZscalerHec.Connections[connectionsIndex58].Pipeline.IsUnknown() && !r.InputZscalerHec.Connections[connectionsIndex58].Pipeline.IsNull() {
				*pipeline117 = r.InputZscalerHec.Connections[connectionsIndex58].Pipeline.ValueString()
			} else {
				pipeline117 = nil
			}
			var output59 string
			output59 = r.InputZscalerHec.Connections[connectionsIndex58].Output.ValueString()

			connections58 = append(connections58, shared.InputZscalerHecConnection{
		...
		if r.InputZscalerHec.Pq != nil {
			...
			if !r.InputZscalerHec.Pq.MaxBufferSize.IsUnknown() && !r.InputZscalerHec.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize62 = r.InputZscalerHec.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize62 = nil
			}
		...
		for authTokensIndex9 := range r.InputZscalerHec.AuthTokens {
			...
			if !r.InputZscalerHec.AuthTokens[authTokensIndex9].Description.IsUnknown() && !r.InputZscalerHec.AuthTokens[authTokensIndex9].Description.IsNull() {
				*description69 = r.InputZscalerHec.AuthTokens[authTokensIndex9].Description.ValueString()
			} else {
				description69 = nil
			}
			...
			metadata64 := make([]shared.InputZscalerHecAuthTokenMetadatum, 0, len(r.InputZscalerHec.AuthTokens[authTokensIndex9].Metadata))
			for metadataIndex63 := range r.InputZscalerHec.AuthTokens[authTokensIndex9].Metadata {
				var name83 string
				name83 = r.InputZscalerHec.AuthTokens[authTokensIndex9].Metadata[metadataIndex63].Name.ValueString()

				var value78 string
				value78 = r.InputZscalerHec.AuthTokens[authTokensIndex9].Metadata[metadataIndex63].Value.ValueString()
		...
		for metadataIndex64 := range r.InputZscalerHec.Metadata {
			var name84 string
			name84 = r.InputZscalerHec.Metadata[metadataIndex64].Name.ValueString()

			var value79 string
			value79 = r.InputZscalerHec.Metadata[metadataIndex64].Value.ValueString()
	...
	if r.InputCloudflareHec != nil {
		...
		if !r.InputCloudflareHec.ID.IsUnknown() && !r.InputCloudflareHec.ID.IsNull() {
			*id60 = r.InputCloudflareHec.ID.ValueString()
		} else {
			id60 = nil
		}
		typeVar64 := shared.InputCloudflareHecType(r.InputCloudflareHec.Type.ValueString())
		disabled104 := new(bool)
		if !r.InputCloudflareHec.Disabled.IsUnknown() && !r.InputCloudflareHec.Disabled.IsNull() {
			*disabled104 = r.InputCloudflareHec.Disabled.ValueBool()
		} else {
			disabled104 = nil
		}
		pipeline118 := new(string)
		if !r.InputCloudflareHec.Pipeline.IsUnknown() && !r.InputCloudflareHec.Pipeline.IsNull() {
			*pipeline118 = r.InputCloudflareHec.Pipeline.ValueString()
		} else {
			pipeline118 = nil
		}
		sendToRoutes59 := new(bool)
		if !r.InputCloudflareHec.SendToRoutes.IsUnknown() && !r.InputCloudflareHec.SendToRoutes.IsNull() {
			*sendToRoutes59 = r.InputCloudflareHec.SendToRoutes.ValueBool()
		} else {
			sendToRoutes59 = nil
		}
		environment59 := new(string)
		if !r.InputCloudflareHec.Environment.IsUnknown() && !r.InputCloudflareHec.Environment.IsNull() {
			*environment59 = r.InputCloudflareHec.Environment.ValueString()
		} else {
			environment59 = nil
		}
		pqEnabled59 := new(bool)
		if !r.InputCloudflareHec.PqEnabled.IsUnknown() && !r.InputCloudflareHec.PqEnabled.IsNull() {
			*pqEnabled59 = r.InputCloudflareHec.PqEnabled.ValueBool()
		} else {
			pqEnabled59 = nil
		}
		streamtags59 := make([]string, 0, len(r.InputCloudflareHec.Streamtags))
		for streamtagsIndex59 := range r.InputCloudflareHec.Streamtags {
			streamtags59 = append(streamtags59, r.InputCloudflareHec.Streamtags[streamtagsIndex59].ValueString())
		}
		connections59 := make([]shared.InputCloudflareHecConnection, 0, len(r.InputCloudflareHec.Connections))
		for connectionsIndex59 := range r.InputCloudflareHec.Connections {
			pipeline119 := new(string)
			if !r.InputCloudflareHec.Connections[connectionsIndex59].Pipeline.IsUnknown() && !r.InputCloudflareHec.Connections[connectionsIndex59].Pipeline.IsNull() {
				*pipeline119 = r.InputCloudflareHec.Connections[connectionsIndex59].Pipeline.ValueString()
			} else {
				pipeline119 = nil
			}
			var output60 string
			output60 = r.InputCloudflareHec.Connections[connectionsIndex59].Output.ValueString()

			connections59 = append(connections59, shared.InputCloudflareHecConnection{
				Pipeline: pipeline119,
				Output:   output60,
			})
		}
		var pq59 *shared.InputCloudflareHecPq
		if r.InputCloudflareHec.Pq != nil {
			mode73 := new(shared.InputCloudflareHecMode)
			if !r.InputCloudflareHec.Pq.Mode.IsUnknown() && !r.InputCloudflareHec.Pq.Mode.IsNull() {
				*mode73 = shared.InputCloudflareHecMode(r.InputCloudflareHec.Pq.Mode.ValueString())
			} else {
				mode73 = nil
			}
			...
			if !r.InputCloudflareHec.Pq.MaxBufferSize.IsUnknown() && !r.InputCloudflareHec.Pq.MaxBufferSize.IsNull() {
				*maxBufferSize63 = r.InputCloudflareHec.Pq.MaxBufferSize.ValueFloat64()
			} else {
				maxBufferSize63 = nil
			}
			...
			if !r.InputCloudflareHec.Pq.CommitFrequency.IsUnknown() && !r.InputCloudflareHec.Pq.CommitFrequency.IsNull() {
				*commitFrequency59 = r.InputCloudflareHec.Pq.CommitFrequency.ValueFloat64()
			} else {
			...
			if !r.InputCloudflareHec.Pq.MaxFileSize.IsUnknown() && !r.InputCloudflareHec.Pq.MaxFileSize.IsNull() {
				*maxFileSize59 = r.InputCloudflareHec.Pq.MaxFileSize.ValueString()
			} else {
				maxFileSize59 = nil
			}
			maxSize59 := new(string)
			if !r.InputCloudflareHec.Pq.MaxSize.IsUnknown() && !r.InputCloudflareHec.Pq.MaxSize.IsNull() {
				*maxSize59 = r.InputCloudflareHec.Pq.MaxSize.ValueString()
			} else {
				maxSize59 = nil
			}
			path62 := new(string)
			if !r.InputCloudflareHec.Pq.Path.IsUnknown() && !r.InputCloudflareHec.Pq.Path.IsNull() {
				*path62 = r.InputCloudflareHec.Pq.Path.ValueString()
			} else {
				path62 = nil
			}
			compress68 := new(shared.InputCloudflareHecCompression)
			if !r.InputCloudflareHec.Pq.Compress.IsUnknown() && !r.InputCloudflareHec.Pq.Compress.IsNull() {
				*compress68 = shared.InputCloudflareHecCompression(r.InputCloudflareHec.Pq.Compress.ValueString())
			} else {
				compress68 = nil
			}
			...
			pq59 = &shared.InputCloudflareHecPq{
				Mode:            mode73,
		...
		if !r.InputCloudflareHec.Host.IsUnknown() && !r.InputCloudflareHec.Host.IsNull() {
			*host29 = r.InputCloudflareHec.Host.ValueString()
		} else {
			host29 = nil
		}
		var port25 float64
		...
		for authTokensIndex10 := range r.InputCloudflareHec.AuthTokens {
			...
			if !r.InputCloudflareHec.AuthTokens[authTokensIndex10].TokenSecret.IsUnknown() && !r.InputCloudflareHec.AuthTokens[authTokensIndex10].TokenSecret.IsNull() {
				*tokenSecret2 = r.InputCloudflareHec.AuthTokens[authTokensIndex10].TokenSecret.ValueString()
			} else {
				tokenSecret2 = nil
			}
			token12 := new(string)
			...
			if !r.InputCloudflareHec.AuthTokens[authTokensIndex10].Enabled.IsUnknown() && !r.InputCloudflareHec.AuthTokens[authTokensIndex10].Enabled.IsNull() {
				*enabled11 = r.InputCloudflareHec.AuthTokens[authTokensIndex10].Enabled.ValueBool()
			} else {
				enabled11 = nil
			}
			...
			if !r.InputCloudflareHec.AuthTokens[authTokensIndex10].Description.IsUnknown() && !r.InputCloudflareHec.AuthTokens[authTokensIndex10].Description.IsNull() {
				*description71 = r.InputCloudflareHec.AuthTokens[authTokensIndex10].Description.ValueString()
			} else {
				description71 = nil
			}
			...
			metadata66 := make([]shared.InputCloudflareHecAuthTokenMetadatum, 0, len(r.InputCloudflareHec.AuthTokens[authTokensIndex10].Metadata))
			for metadataIndex65 := range r.InputCloudflareHec.AuthTokens[authTokensIndex10].Metadata {
				var name85 string
				name85 = r.InputCloudflareHec.AuthTokens[authTokensIndex10].Metadata[metadataIndex65].Name.ValueString()

				var value80 string
				value80 = r.InputCloudflareHec.AuthTokens[authTokensIndex10].Metadata[metadataIndex65].Value.ValueString()

				metadata66 = append(metadata66, shared.InputCloudflareHecAuthTokenMetadatum{
					Name:  name85,
					Value: value80,
				})
			}
		...
		var tls30 *shared.InputCloudflareHecTLSSettingsServerSide
		if r.InputCloudflareHec.TLS != nil {
			...
			if !r.InputCloudflareHec.TLS.Disabled.IsUnknown() && !r.InputCloudflareHec.TLS.Disabled.IsNull() {
				*disabled105 = r.InputCloudflareHec.TLS.Disabled.ValueBool()
			} else {
				disabled105 = nil
			}
			requestCert23 := new(bool)
			if !r.InputCloudflareHec.TLS.RequestCert.IsUnknown() && !r.InputCloudflareHec.TLS.RequestCert.IsNull() {
				*requestCert23 = r.InputCloudflareHec.TLS.RequestCert.ValueBool()
			} else {
				requestCert23 = nil
			}
			...
			if !r.InputCloudflareHec.TLS.RejectUnauthorized.IsUnknown() && !r.InputCloudflareHec.TLS.RejectUnauthorized.IsNull() {
				*rejectUnauthorized42 = r.InputCloudflareHec.TLS.RejectUnauthorized.ValueBool()
			} else {
			...
			if !r.InputCloudflareHec.TLS.CommonNameRegex.IsUnknown() && !r.InputCloudflareHec.TLS.CommonNameRegex.IsNull() {
				*commonNameRegex23 = r.InputCloudflareHec.TLS.CommonNameRegex.ValueString()
			} else {
			...
			if !r.InputCloudflareHec.TLS.CertificateName.IsUnknown() && !r.InputCloudflareHec.TLS.CertificateName.IsNull() {
				*certificateName31 = r.InputCloudflareHec.TLS.CertificateName.ValueString()
			} else {
			...
			if !r.InputCloudflareHec.TLS.PrivKeyPath.IsUnknown() && !r.InputCloudflareHec.TLS.PrivKeyPath.IsNull() {
				*privKeyPath30 = r.InputCloudflareHec.TLS.PrivKeyPath.ValueString()
			} else {
				privKeyPath30 = nil
			}
			passphrase29 := new(string)
			if !r.InputCloudflareHec.TLS.Passphrase.IsUnknown() && !r.InputCloudflareHec.TLS.Passphrase.IsNull() {
				*passphrase29 = r.InputCloudflareHec.TLS.Passphrase.ValueString()
			} else {
				passphrase29 = nil
			}
			certPath30 := new(string)
			if !r.InputCloudflareHec.TLS.CertPath.IsUnknown() && !r.InputCloudflareHec.TLS.CertPath.IsNull() {
				*certPath30 = r.InputCloudflareHec.TLS.CertPath.ValueString()
			} else {
				certPath30 = nil
			}
			caPath29 := new(string)
			if !r.InputCloudflareHec.TLS.CaPath.IsUnknown() && !r.InputCloudflareHec.TLS.CaPath.IsNull() {
				*caPath29 = r.InputCloudflareHec.TLS.CaPath.ValueString()
			} else {
				caPath29 = nil
			}
			minVersion29 := new(shared.InputCloudflareHecMinimumTLSVersion)
			if !r.InputCloudflareHec.TLS.MinVersion.IsUnknown() && !r.InputCloudflareHec.TLS.MinVersion.IsNull() {
				*minVersion29 = shared.InputCloudflareHecMinimumTLSVersion(r.InputCloudflareHec.TLS.MinVersion.ValueString())
			} else {
				minVersion29 = nil
			}
			maxVersion29 := new(shared.InputCloudflareHecMaximumTLSVersion)
			if !r.InputCloudflareHec.TLS.MaxVersion.IsUnknown() && !r.InputCloudflareHec.TLS.MaxVersion.IsNull() {
				*maxVersion29 = shared.InputCloudflareHecMaximumTLSVersion(r.InputCloudflareHec.TLS.MaxVersion.ValueString())
			} else {
				maxVersion29 = nil
			}
			tls30 = &shared.InputCloudflareHecTLSSettingsServerSide{
		...
		if !r.InputCloudflareHec.EnableProxyHeader.IsUnknown() && !r.InputCloudflareHec.EnableProxyHeader.IsNull() {
			*enableProxyHeader22 = r.InputCloudflareHec.EnableProxyHeader.ValueBool()
		} else {
		...
		metadata67 := make([]shared.InputCloudflareHecMetadatum, 0, len(r.InputCloudflareHec.Metadata))
		for metadataIndex66 := range r.InputCloudflareHec.Metadata {
			var name86 string
			name86 = r.InputCloudflareHec.Metadata[metadataIndex66].Name.ValueString()

			var value81 string
			value81 = r.InputCloudflareHec.Metadata[metadataIndex66].Value.ValueString()

			metadata67 = append(metadata67, shared.InputCloudflareHecMetadatum{
				Name:  name86,
				Value: value81,
			})
		}
		allowedIndexes2 := make([]string, 0, len(r.InputCloudflareHec.AllowedIndexes))
		for allowedIndexesIndex2 := range r.InputCloudflareHec.AllowedIndexes {
			allowedIndexes2 = append(allowedIndexes2, r.InputCloudflareHec.AllowedIndexes[allowedIndexesIndex2].ValueString())
		}
		breakerRulesets16 := make([]string, 0, len(r.InputCloudflareHec.BreakerRulesets))
		for breakerRulesetsIndex16 := range r.InputCloudflareHec.BreakerRulesets {
			breakerRulesets16 = append(breakerRulesets16, r.InputCloudflareHec.BreakerRulesets[breakerRulesetsIndex16].ValueString())
		}
		staleChannelFlushMs16 := new(float64)
		if !r.InputCloudflareHec.StaleChannelFlushMs.IsUnknown() && !r.InputCloudflareHec.StaleChannelFlushMs.IsNull() {
			*staleChannelFlushMs16 = r.InputCloudflareHec.StaleChannelFlushMs.ValueFloat64()
		} else {
			staleChannelFlushMs16 = nil
		}
		accessControlAllowOrigin2 := make([]string, 0, len(r.InputCloudflareHec.AccessControlAllowOrigin))
		for accessControlAllowOriginIndex2 := range r.InputCloudflareHec.AccessControlAllowOrigin {
			accessControlAllowOrigin2 = append(accessControlAllowOrigin2, r.InputCloudflareHec.AccessControlAllowOrigin[accessControlAllowOriginIndex2].ValueString())
		}
		accessControlAllowHeaders2 := make([]string, 0, len(r.InputCloudflareHec.AccessControlAllowHeaders))
		for accessControlAllowHeadersIndex2 := range r.InputCloudflareHec.AccessControlAllowHeaders {
			accessControlAllowHeaders2 = append(accessControlAllowHeaders2, r.InputCloudflareHec.AccessControlAllowHeaders[accessControlAllowHeadersIndex2].ValueString())
		}
		emitTokenMetrics2 := new(bool)
		if !r.InputCloudflareHec.EmitTokenMetrics.IsUnknown() && !r.InputCloudflareHec.EmitTokenMetrics.IsNull() {
			*emitTokenMetrics2 = r.InputCloudflareHec.EmitTokenMetrics.ValueBool()
		} else {
		...
		if !r.InputCloudflareHec.Description.IsUnknown() && !r.InputCloudflareHec.Description.IsNull() {
			*description72 = r.InputCloudflareHec.Description.ValueString()
		} else {
			description72 = nil
		}
