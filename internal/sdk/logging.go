...
func (s *Logging) GetSystemJobsLogsByIDAndGroupID(ctx context.Context, request operations.GetSystemJobsLogsByIDAndGroupIDRequest, opts ...operations.Option) (*operations.GetSystemJobsLogsByIDAndGroupIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemJobsLogsByIDAndGroupIDServerList[operations.GetSystemJobsLogsByIDAndGroupIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
...
func (s *Logging) GetSystemLogsByID(ctx context.Context, request operations.GetSystemLogsByIDRequest, opts ...operations.Option) (*operations.GetSystemLogsByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemLogsByIDServerList[operations.GetSystemLogsByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Logging) GetSystemLogs(ctx context.Context, opts ...operations.Option) (*operations.GetSystemLogsResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemLogsServerList[operations.GetSystemLogsServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Logging) GetSystemLogsSearch(ctx context.Context, request operations.GetSystemLogsSearchRequest, opts ...operations.Option) (*operations.GetSystemLogsSearchResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemLogsSearchServerList[operations.GetSystemLogsSearchServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
