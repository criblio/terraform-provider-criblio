...
func (s *SavedJobs) ListSavedJob(ctx context.Context, opts ...operations.Option) (*operations.ListSavedJobResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.ListSavedJobServerList[operations.ListSavedJobServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
...
func (s *SavedJobs) CreateSavedJob(ctx context.Context, request shared.SavedJob, opts ...operations.Option) (*operations.CreateSavedJobResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.CreateSavedJobServerList[operations.CreateSavedJobServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *SavedJobs) GetSavedJobByID(ctx context.Context, request operations.GetSavedJobByIDRequest, opts ...operations.Option) (*operations.GetSavedJobByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSavedJobByIDServerList[operations.GetSavedJobByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *SavedJobs) UpdateSavedJobByID(ctx context.Context, request operations.UpdateSavedJobByIDRequest, opts ...operations.Option) (*operations.UpdateSavedJobByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.UpdateSavedJobByIDServerList[operations.UpdateSavedJobByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *SavedJobs) DeleteSavedJobByID(ctx context.Context, request operations.DeleteSavedJobByIDRequest, opts ...operations.Option) (*operations.DeleteSavedJobByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteSavedJobByIDServerList[operations.DeleteSavedJobByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
