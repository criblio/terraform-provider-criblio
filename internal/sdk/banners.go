...
func (s *Banners) ListBannerMessage(ctx context.Context, opts ...operations.Option) (*operations.ListBannerMessageResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.ListBannerMessageServerList[operations.ListBannerMessageServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
...
func (s *Banners) CreateBannerMessage(ctx context.Context, request shared.BannerMessage, opts ...operations.Option) (*operations.CreateBannerMessageResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.CreateBannerMessageServerList[operations.CreateBannerMessageServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Banners) GetBannerMessageByID(ctx context.Context, request operations.GetBannerMessageByIDRequest, opts ...operations.Option) (*operations.GetBannerMessageByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetBannerMessageByIDServerList[operations.GetBannerMessageByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Banners) UpdateBannerMessageByID(ctx context.Context, request operations.UpdateBannerMessageByIDRequest, opts ...operations.Option) (*operations.UpdateBannerMessageByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.UpdateBannerMessageByIDServerList[operations.UpdateBannerMessageByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Banners) DeleteBannerMessageByID(ctx context.Context, request operations.DeleteBannerMessageByIDRequest, opts ...operations.Option) (*operations.DeleteBannerMessageByIDResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteBannerMessageByIDServerList[operations.DeleteBannerMessageByIDServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
