...
func (s *Diag) GetHealthInfo(ctx context.Context, opts ...operations.Option) (*operations.GetHealthInfoResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetHealthInfoServerList[operations.GetHealthInfoServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
...
func (s *Diag) GetDiagBundle(ctx context.Context, opts ...operations.Option) (*operations.GetDiagBundleResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetDiagBundleServerList[operations.GetDiagBundleServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Diag) GetSystemInfo(ctx context.Context, opts ...operations.Option) (*operations.GetSystemInfoResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemInfoServerList[operations.GetSystemInfoServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Diag) GetSystemDiag(ctx context.Context, opts ...operations.Option) (*operations.GetSystemDiagResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.GetSystemDiagServerList[operations.GetSystemDiagServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Diag) DeleteSystemDiag(ctx context.Context, request operations.DeleteSystemDiagRequest, opts ...operations.Option) (*operations.DeleteSystemDiagResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.DeleteSystemDiagServerList[operations.DeleteSystemDiagServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
...
func (s *Diag) CreateSystemDiagSend(ctx context.Context, request shared.SendDiagBundle, opts ...operations.Option) (*operations.CreateSystemDiagSendResponse, error) {
	...
	baseURL := utils.ReplaceParameters(operations.CreateSystemDiagSendServerList[operations.CreateSystemDiagSendServerCloud], map[string]string{
		"workspaceName":  "main",
		"organizationId": "ian",
		"cloudDomain":    "cribl.cloud",
		"groupName":      "default",
