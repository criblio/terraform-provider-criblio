...
// Generated from OpenAPI doc version 4.12.2-4b17c8d4-TFProvider-manual and generator version 2.663.0
...
func New(opts ...SDKOption) *CriblIo {
	sdk := &CriblIo{
		SDKVersion: "1.0.63",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.0.63 2.663.0 4.12.2-4b17c8d4-TFProvider-manual github.com/criblio/terraform-provider-criblio/internal/sdk",
