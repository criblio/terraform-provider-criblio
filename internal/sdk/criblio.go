...
// Generated from OpenAPI doc version 4.12.2-4b17c8d4 and generator version 2.722.5
...
func New(opts ...SDKOption) *CriblIo {
	sdk := &CriblIo{
		SDKVersion: "1.14.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 1.14.5 2.722.5 4.12.2-4b17c8d4 github.com/criblio/terraform-provider-criblio/internal/sdk",
