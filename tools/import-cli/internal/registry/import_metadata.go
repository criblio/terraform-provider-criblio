...
var importMetadataOverrides = map[string]ResourceMetadata{
	...
	"criblio_key":                          {SDKService: "Keys", ListMethod: "ListKeyMetadataEntity", GetMethod: "GetKeyMetadataEntityByID", ImportIDFormat: "json:group_id,id", ListItemIDMethod: "GetKeyID"},
