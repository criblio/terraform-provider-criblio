...
var importMetadataOverrides = map[string]ResourceMetadata{
	...
	"criblio_search_dashboard_category":    {ListMethod: "ListDashboardCategory", ImportIDFormat: "json:group_id,id"},
	...
	"criblio_search_macro":                 {ImportIDFormat: "json:group_id,id"},
	"criblio_search_saved_query":           {ListMethod: "ListSavedQuery", ImportIDFormat: "json:group_id,id"},
	...
	"criblio_search_engine":                {ImportIDFormat: "json:group_id,id"},
	"criblio_search_source":                {ImportIDFormat: "json:group_id,id"},
