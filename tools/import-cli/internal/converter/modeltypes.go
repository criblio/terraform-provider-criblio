...
func ResourceModelTypes() map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"MonitorResourceModel":                    reflect.TypeOf((*provider.MonitorResourceModel)(nil)).Elem(),
		...
		"ProjectPipelineResourceModel":            reflect.TypeOf((*provider.ProjectPipelineResourceModel)(nil)).Elem(),
		...
		"SearchSourceResourceModel":               reflect.TypeOf((*provider.SearchSourceResourceModel)(nil)).Elem(),
...
func GeneratedModelTypes() map[string]reflect.Type {
	return map[string]reflect.Type{
		...
		"GroupSystemSettingsResourceModel":        reflect.TypeOf((*provider.GroupSystemSettingsModel)(nil)).Elem(),
		...
		"MonitorResourceModel":                    reflect.TypeOf((*provider.MonitorModel)(nil)).Elem(),
		"PackBreakersResourceModel":               reflect.TypeOf((*provider.PackBreakersModel)(nil)).Elem(),
		"PackDestinationResourceModel":            reflect.TypeOf((*provider.PackDestinationModel)(nil)).Elem(),
		"PackLookupsResourceModel":                reflect.TypeOf((*provider.PackLookupsModel)(nil)).Elem(),
		"PackPipelineResourceModel":               reflect.TypeOf((*provider.PackPipelineModel)(nil)).Elem(),
		"PackRoutesResourceModel":                 reflect.TypeOf((*provider.PackRoutesModel)(nil)).Elem(),
		"PackSourceResourceModel":                 reflect.TypeOf((*provider.PackSourceModel)(nil)).Elem(),
		"PackVarsResourceModel":                   reflect.TypeOf((*provider.PackVarsModel)(nil)).Elem(),
		...
		"ProjectPipelineResourceModel":            reflect.TypeOf((*provider.ProjectPipelineModel)(nil)).Elem(),
		...
		"SearchSourceResourceModel":               reflect.TypeOf((*provider.SearchSourceModel)(nil)).Elem(),
		"NotificationResourceModel":               reflect.TypeOf((*provider.NotificationModel)(nil)).Elem(),
		"NotificationTargetResourceModel":         reflect.TypeOf((*provider.NotificationTargetModel)(nil)).Elem(),
		"SecretResourceModel":                     reflect.TypeOf((*provider.SecretModel)(nil)).Elem(),
		"SourceResourceModel":                     reflect.TypeOf((*provider.SourceModel)(nil)).Elem(),
