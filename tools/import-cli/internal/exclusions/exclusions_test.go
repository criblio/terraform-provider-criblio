...
func TestSkipExportIDs_ContainsExpectedTypesAndIDs(t *testing.T) {
	tests := []struct {
		...
		{"criblio_pipeline", "metrics_ingest", true},
		{"criblio_pack_pipeline", "metrics_ingest", true},
		{"criblio_project_pipeline", "metrics_ingest", true},
		{"criblio_pipeline", "custom_pipeline", false},
