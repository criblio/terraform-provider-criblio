...
allEnvs=(
    'criblio_subscription.my_subscription/{"group_id": "default", "id": "my_subscription"}'
    'criblio_subscription.my_subscription_with_enabled/{"group_id": "default", "id": "my_subscription_with_enabled"}'
...
cloud=(
    'criblio_group.syslog_worker_group/syslog-workers'
