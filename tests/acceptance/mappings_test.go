			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("criblio_mapping_ruleset.stream_mappings", "id", "default"),
						...
						resource.TestCheckResourceAttr("criblio_mapping_ruleset.stream_mappings", "conf.functions.0.final", "true"),
						...
						resource.TestCheckResourceAttr("criblio_mapping_ruleset.edge_mappings", "id", "default"),
						...
						resource.TestCheckResourceAttr("criblio_mapping_ruleset.edge_mappings", "conf.functions.0.final", "true"),
