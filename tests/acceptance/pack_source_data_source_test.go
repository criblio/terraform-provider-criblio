...
func TestPackSourceDataSources(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `resource "criblio_pack_source" "my_packsource" {
  group_id = "default"
...
data "criblio_pack_source" "by_id" {
  group_id = criblio_pack_source.my_packsource.group_id
  id = criblio_pack_source.my_packsource.id
  pack = criblio_pack_source.my_packsource.pack
  depends_on = [criblio_pack_source.my_packsource]
}`,
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttrPair("data.criblio_pack_source.by_id", "group_id", "criblio_pack_source.my_packsource", "group_id"),
					resource.TestCheckResourceAttrPair("data.criblio_pack_source.by_id", "id", "criblio_pack_source.my_packsource", "id"),
					resource.TestCheckResourceAttrPair("data.criblio_pack_source.by_id", "pack", "criblio_pack_source.my_packsource", "pack"),
				),
			},
		},
	})
