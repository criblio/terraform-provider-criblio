			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("criblio_pack_destination.my_packsource", "id", "my_id"),
						resource.TestCheckResourceAttr("criblio_pack_destination.my_packsource", "group_id", "my_group_id"),
					),
				},
				{
					ConfigDirectory: config.TestNameDirectory(),
