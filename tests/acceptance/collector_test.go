			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeAggregateTestCheckFunc(
						...
						resource.TestCheckResourceAttr("criblio_collector.script_collector", "id", "rest-api-demo-collector"),
						...
						resource.TestCheckResourceAttr("criblio_collector.script_collector", 
						        "input_collector_rest.collector.conf.shell", "/bin/bash"),
						resource.TestCheckResourceAttr("criblio_collector.script_collector", 
						        "input_collector_rest.collector.conf.discover_script", "echo 1"),
