...
e2e-test:
	...
	@cd tests/e2e; terraform import criblio_group.syslog_worker_group "syslog-workers"; terraform import criblio_group.my_edge_fleet "my-edge-fleet"; terraform import criblio_regex.my_regex "default"; terraform import criblio_appscope_config.my_appscopeconfig "default"; terraform import criblio_grok.my_grok "default"; terraform import criblio_global_var.my_globalvar "default"; terraform import criblio_subscription.my_subscription "default"
