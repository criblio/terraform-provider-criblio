...
e2e-test:
	...
	@echo 'import { ' >> tests/e2e/appscope_config.tf; echo 'to = criblio_appscope_config.my_appscopeconfig ' >> tests/e2e/appscope_config.tf; echo 'id = "sample_appscope_config" ' >> tests/e2e/appscope_config.tf; echo '}' >> tests/e2e/appscope_config.tf
